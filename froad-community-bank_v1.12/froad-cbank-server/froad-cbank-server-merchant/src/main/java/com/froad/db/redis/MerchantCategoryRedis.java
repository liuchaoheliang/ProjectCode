...
public class MerchantCategoryRedis {
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_merchant_category_detail_client_id_category_id(MerchantCategory merchantCategory) {
...
//-----------------
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_merchant_category_all_client_id_merchant_category_id(MerchantCategory merchantCategory, String merchant_id) {
	...
	/**
	 * 
	 * @Title: get_cbbank_merchant_category_h5_client_id_category_id
	 * @author trimray
	 * @version 1.0
	 * @see: TODO
	 * @param client_id
	 ...
	 * @throws
	 */
	public static String get_cbbank_merchant_category_h5_client_id_category_id(String client_id, Long category_id,Long area_id) {
		String key = RedisKeyUtil.cbbank_merchant_category_h5_client_id_category_id(client_id, category_id,area_id) ;
		if(redis.exists(key)){
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_merchant_category_h5_client_id_category_id(MerchantCategory merchantCategory,String value) {
		boolean flag = false;
		String key = RedisKeyUtil.cbbank_merchant_category_h5_client_id_category_id(merchantCategory.getClientId(), merchantCategory.getId(),merchantCategory.getAreaId());
		if(redis.setnx(key, value).longValue()>0){
			if(redis.expire(key, 60*10)>0){
				flag = true;
			}
		}
		return flag;
