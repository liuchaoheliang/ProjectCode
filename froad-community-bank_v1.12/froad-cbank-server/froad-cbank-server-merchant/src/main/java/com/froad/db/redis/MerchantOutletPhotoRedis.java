...
public class MerchantOutletPhotoRedis {
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_merchant_outlet_image_client_id_merchant_id_outlet_id(String client_id, MerchantOutletPhoto merchantOutletPhoto) {
		boolean flag = false;
		Map<String, String> hash = new HashMap<String, String>();
//			hash.put("is_default", BooleanUtils.toString(merchantOutletPhoto.getIsDefault(), "1", "0", ""));
	...
	public static boolean del_cbbank_merchant_outlet_image_client_id_merchant_id_outlet_id(String client_id, MerchantOutletPhoto merchantOutletPhoto) {
		return del_cbbank_merchant_outlet_image_client_id_merchant_id_outlet_id(client_id, merchantOutletPhoto.getMerchantId(), merchantOutletPhoto.getOutletId());
	}
	
	public static boolean del_cbbank_merchant_outlet_image_client_id_merchant_id_outlet_id(String client_id, String merchantId, String outletId) {
		String key = RedisKeyUtil.cbbank_merchant_outlet_image_client_id_merchant_id_outlet_id(client_id, merchantId, outletId);
