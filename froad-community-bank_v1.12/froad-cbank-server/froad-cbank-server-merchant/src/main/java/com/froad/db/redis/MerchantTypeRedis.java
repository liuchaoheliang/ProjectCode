...
public class MerchantTypeRedis {
	 ...
	 * @throws
	 */
	public static String get_cbbank_merchant_type_merchant_type_id(String clientId,String type_id) {
		String key = RedisKeyUtil.cbbank_merchant_type_merchant_type_id(clientId) ;
	 ...
	 * @throws
	 */
	public static Map<String, String> getAll_cbbank_merchant_type_merchant_type_id(String clientId) {
		String key = RedisKeyUtil.cbbank_merchant_type_merchant_type_id(clientId);
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_merchant_type_merchant_type_id(MerchantType... merchantTypes) {
		
		String key = RedisKeyUtil.cbbank_merchant_type_merchant_type_id(merchantTypes[0].getClientId());
		Map<String,String> hash = new HashMap<String, String>();
		for (MerchantType merchantType : merchantTypes) {
			hash.put(merchantType.getId().toString(), JSON.toJSONString(merchantType));
		}
	 ...
	 * @throws
	 */
	public static boolean del_cbbank_merchant_type_merchant_type_id(String clientId) {
		String key = RedisKeyUtil.cbbank_merchant_type_merchant_type_id(clientId);
