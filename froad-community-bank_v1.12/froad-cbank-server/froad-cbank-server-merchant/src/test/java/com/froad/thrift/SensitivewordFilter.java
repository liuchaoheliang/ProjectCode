...
public class SensitivewordFilter {
	...
	public String getSensitiveWordByObject(Object o) throws Exception {
...
//			Set<String> set = getSensitiveWord(String.valueOf(returnValue), 1);
//			if(set.size() > 0){
//				throw new Exception(fieldName+"有敏感词!");
//			}
			if(returnValue != null){
...
//			System.out.println(String.valueOf(returnValue));
	...
	public void yanzhe(Object o){
		try{
			...
			boolean isSense = false;//swService.isContaintSensitiveWord(getSensitiveWordByObject(o));
			if( isSense ){
				System.out.println((COMMENT_DESC_EXIST_SENSE));
			}
		}catch(Exception e){
...
//		System.out.println("总共消耗时间为：" + (endTime - beginTime));
		...
		Outlet vo = new Outlet();
//		vo.setOutletName("sasd法轮功");
		vo.setOutletFullname("anhui0549861580000598364700000598364700000598364700001号店1号店1号店安徽9:00-22:0018917556713杨玄江1891755671210050500 门店描述优惠详情优惠详情优惠详情优惠折扣优惠折扣优惠折扣优惠折扣");
		try {
			filter.yanzhe(vo);
		} catch (Exception e) {
			e.printStackTrace();
