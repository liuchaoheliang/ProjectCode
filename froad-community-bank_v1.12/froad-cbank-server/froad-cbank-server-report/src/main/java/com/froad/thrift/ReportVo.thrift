 ...
 * 商户门店信息
 */
struct ReportMerchantOutletVo{
	/** 支行名称 **/
	1: required string orgName;
	/** 网点名称 **/
	2: required string outletName;	
	/** 网点地址 **/
	3: required string outletAddress;
	/** 商户名称 **/
	4: required string merchantName;			
	/** 商户门店数 **/
	5: required i32 merchantOutletCount;
}

/**
 * 商户门店信息导出返回参数
 */
struct ReportMerchantOutletResVo{
	/** 返回结果 **/
	1:required Common.ResultVo resultVo;
	/** 商户门店信息集合 **/
	2:required list<ReportMerchantOutletVo> merchantOutletVos;
}
...
struct MerchantSaleDetailVo{
	...
	/** 精品预售订单数 **/
	8: optional i32 presellOrderCount;
	/** 名优特惠订单数 **/
	9: optional i32 specialOrderCount;
	/** 订单数 **/
	10: optional i32 orderCount;
	/** 订单总金额 **/
	11: optional double orderAmount;
	/** 退款总金额 **/
	12: optional double refundAmount;
}
...
struct ProductSaleTrendVo{
	...
	1: optional i32 week;
	/** 商品销售数量 **/	
	2: optional i32 saleProductNumber;
}
