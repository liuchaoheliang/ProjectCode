...
public class PresellOrderListRes implements org.apache.thrift.TBase<PresellOrderListRes, PresellOrderListRes._Fields>, java.io.Serializable, Cloneable, Comparable<PresellOrderListRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PresellOrderListRes");
  ...
  static {
    schemes.put(StandardScheme.class, new PresellOrderListResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PresellOrderListResTupleSchemeFactory());
  }

  /**
   * 订单数据
   */
  public List<PresellOrderVo> orders; // required
  /**
   * 查询结果
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.ORDERS, new org.apache.thrift.meta_data.FieldMetaData("orders", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "PresellOrderVo"))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PresellOrderListRes.class, metaDataMap);
  }

  public PresellOrderListRes() {
  }

  public PresellOrderListRes(
    List<PresellOrderVo> orders,
   ...
   */
  public PresellOrderListRes(PresellOrderListRes other) {
    if (other.isSetOrders()) {
      List<PresellOrderVo> __this__orders = new ArrayList<PresellOrderVo>(other.orders.size());
      for (PresellOrderVo other_element : other.orders) {
  ...
  public PresellOrderListRes deepCopy() {
    return new PresellOrderListRes(this);
  }
  ...
  public java.util.Iterator<PresellOrderVo> getOrdersIterator() {
    return (this.orders == null) ? null : this.orders.iterator();
  }

  public void addToOrders(PresellOrderVo elem) {
    if (this.orders == null) {
      this.orders = new ArrayList<PresellOrderVo>();
    }
   ...
   * 订单数据
   */
  public List<PresellOrderVo> getOrders() {
    return this.orders;
  }
   ...
   * 订单数据
   */
  public PresellOrderListRes setOrders(List<PresellOrderVo> orders) {
    this.orders = orders;
    return this;
  }
   ...
   * 查询结果
   */
  public PresellOrderListRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 分页数据
   */
  public PresellOrderListRes setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ORDERS:
      if (value == null) {
        ...
        setOrders((List<PresellOrderVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PresellOrderListRes)
      return this.equals((PresellOrderListRes)that);
    return false;
  }

  public boolean equals(PresellOrderListRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PresellOrderListRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PresellOrderListRes(");
    boolean first = true;
  ...
  private static class PresellOrderListResStandardSchemeFactory implements SchemeFactory {
    public PresellOrderListResStandardScheme getScheme() {
      return new PresellOrderListResStandardScheme();
    }
  }

  private static class PresellOrderListResStandardScheme extends StandardScheme<PresellOrderListRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PresellOrderListRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orders = new ArrayList<PresellOrderVo>(_list8.size);
                PresellOrderVo _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new PresellOrderVo();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PresellOrderListRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.orders != null) {
        oprot.writeFieldBegin(ORDERS_FIELD_DESC);
        {
          ...
          for (PresellOrderVo _iter11 : struct.orders)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PresellOrderListResTupleSchemeFactory implements SchemeFactory {
    public PresellOrderListResTupleScheme getScheme() {
      return new PresellOrderListResTupleScheme();
    }
  }

  private static class PresellOrderListResTupleScheme extends TupleScheme<PresellOrderListRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PresellOrderListRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOrders()) {
        {
          ...
          for (PresellOrderVo _iter12 : struct.orders)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PresellOrderListRes struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list13 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.orders = new ArrayList<PresellOrderVo>(_list13.size);
          PresellOrderVo _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new PresellOrderVo();
            _elem14.read(iprot);
