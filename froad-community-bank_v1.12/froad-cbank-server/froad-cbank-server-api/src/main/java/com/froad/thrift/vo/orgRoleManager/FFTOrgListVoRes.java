...
public class FFTOrgListVoRes implements org.apache.thrift.TBase<FFTOrgListVoRes, FFTOrgListVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<FFTOrgListVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FFTOrgListVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new FFTOrgListVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FFTOrgListVoResTupleSchemeFactory());
  }
   ...
   * 组织信息集合
   */
  public List<FFTOrgVo> voList; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.VO_LIST, new org.apache.thrift.meta_data.FieldMetaData("voList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, FFTOrgVo.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FFTOrgListVoRes.class, metaDataMap);
  }

  public FFTOrgListVoRes() {
  }

  public FFTOrgListVoRes(
    com.froad.thrift.vo.ResultVo resultVo,
    List<FFTOrgVo> voList)
  {
    this();
   ...
   */
  public FFTOrgListVoRes(FFTOrgListVoRes other) {
    if (other.isSetResultVo()) {
      this.resultVo = new com.froad.thrift.vo.ResultVo(other.resultVo);
    }
    if (other.isSetVoList()) {
      List<FFTOrgVo> __this__voList = new ArrayList<FFTOrgVo>(other.voList.size());
      for (FFTOrgVo other_element : other.voList) {
        __this__voList.add(new FFTOrgVo(other_element));
      }
      this.voList = __this__voList;
    }
  }

  public FFTOrgListVoRes deepCopy() {
    return new FFTOrgListVoRes(this);
  }
   ...
   * 返回结果
   */
  public FFTOrgListVoRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
  ...
  public java.util.Iterator<FFTOrgVo> getVoListIterator() {
    return (this.voList == null) ? null : this.voList.iterator();
  }

  public void addToVoList(FFTOrgVo elem) {
    if (this.voList == null) {
      this.voList = new ArrayList<FFTOrgVo>();
    }
   ...
   * 组织信息集合
   */
  public List<FFTOrgVo> getVoList() {
    return this.voList;
  }
   ...
   * 组织信息集合
   */
  public FFTOrgListVoRes setVoList(List<FFTOrgVo> voList) {
    this.voList = voList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FFTOrgListVoRes)
      return this.equals((FFTOrgListVoRes)that);
    return false;
  }

  public boolean equals(FFTOrgListVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FFTOrgListVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FFTOrgListVoRes(");
    boolean first = true;
  ...
  private static class FFTOrgListVoResStandardSchemeFactory implements SchemeFactory {
    public FFTOrgListVoResStandardScheme getScheme() {
      return new FFTOrgListVoResStandardScheme();
    }
  }

  private static class FFTOrgListVoResStandardScheme extends StandardScheme<FFTOrgListVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FFTOrgListVoRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.voList = new ArrayList<FFTOrgVo>(_list0.size);
                FFTOrgVo _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FFTOrgListVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.voList != null) {
        oprot.writeFieldBegin(VO_LIST_FIELD_DESC);
        {
          ...
          for (FFTOrgVo _iter3 : struct.voList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class FFTOrgListVoResTupleSchemeFactory implements SchemeFactory {
    public FFTOrgListVoResTupleScheme getScheme() {
      return new FFTOrgListVoResTupleScheme();
    }
  }

  private static class FFTOrgListVoResTupleScheme extends TupleScheme<FFTOrgListVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FFTOrgListVoRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetVoList()) {
        {
          ...
          for (FFTOrgVo _iter4 : struct.voList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FFTOrgListVoRes struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.voList = new ArrayList<FFTOrgVo>(_list5.size);
          FFTOrgVo _elem6;
