...
public class OrgUserRoleVo implements org.apache.thrift.TBase<OrgUserRoleVo, OrgUserRoleVo._Fields>, java.io.Serializable, Cloneable, Comparable<OrgUserRoleVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrgUserRoleVo");
  ...
  private static final org.apache.thrift.protocol.TField ORG_LEVEL_FIELD_DESC = new org.apache.thrift.protocol.TField("orgLevel", org.apache.thrift.protocol.TType.STRING, (short)7);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new OrgUserRoleVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrgUserRoleVoTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CLIENT_ID,_Fields.ROLE_NAME,_Fields.ROLE_ID,_Fields.ORG_CODE,_Fields.USERNAME,_Fields.ORG_LEVEL};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrgUserRoleVo.class, metaDataMap);
  }

  public OrgUserRoleVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public OrgUserRoleVo(OrgUserRoleVo other) {
  ...
  public OrgUserRoleVo deepCopy() {
    return new OrgUserRoleVo(this);
  }
   ...
   * 主键id
   */
  public OrgUserRoleVo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
   ...
   * 客户端id
   */
  public OrgUserRoleVo setClientId(String clientId) {
   ...
   * 角色名称
   */
  public OrgUserRoleVo setRoleName(String roleName) {
   ...
   * 角色id
   */
  public OrgUserRoleVo setRoleId(long roleId) {
    this.roleId = roleId;
    setRoleIdIsSet(true);
    return this;
  }
   ...
   * 机构编号
   */
  public OrgUserRoleVo setOrgCode(String orgCode) {
   ...
   * 登录名
   */
  public OrgUserRoleVo setUsername(String username) {
   ...
   * 机构级别
   */
  public OrgUserRoleVo setOrgLevel(String orgLevel) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrgUserRoleVo)
      return this.equals((OrgUserRoleVo)that);
    return false;
  }

  public boolean equals(OrgUserRoleVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OrgUserRoleVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrgUserRoleVo(");
    boolean first = true;
  ...
  private static class OrgUserRoleVoStandardSchemeFactory implements SchemeFactory {
    public OrgUserRoleVoStandardScheme getScheme() {
      return new OrgUserRoleVoStandardScheme();
    }
  }

  private static class OrgUserRoleVoStandardScheme extends StandardScheme<OrgUserRoleVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrgUserRoleVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrgUserRoleVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OrgUserRoleVoTupleSchemeFactory implements SchemeFactory {
    public OrgUserRoleVoTupleScheme getScheme() {
      return new OrgUserRoleVoTupleScheme();
    }
  }

  private static class OrgUserRoleVoTupleScheme extends TupleScheme<OrgUserRoleVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrgUserRoleVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrgUserRoleVo struct) throws org.apache.thrift.TException {
