...
public class ClientPaymentChannelAddVoRes implements org.apache.thrift.TBase<ClientPaymentChannelAddVoRes, ClientPaymentChannelAddVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<ClientPaymentChannelAddVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ClientPaymentChannelAddVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new ClientPaymentChannelAddVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ClientPaymentChannelAddVoResTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ClientPaymentChannelAddVoRes.class, metaDataMap);
  }

  public ClientPaymentChannelAddVoRes() {
  }
   ...
   */
  public ClientPaymentChannelAddVoRes(ClientPaymentChannelAddVoRes other) {
  ...
  public ClientPaymentChannelAddVoRes deepCopy() {
    return new ClientPaymentChannelAddVoRes(this);
  }
   ...
   * 响应基础信息
   */
  public ClientPaymentChannelAddVoRes setResult(com.froad.thrift.vo.ResultVo result) {
    this.result = result;
    return this;
  }
   ...
   * 主键payment_channel_id
   */
  public ClientPaymentChannelAddVoRes setPaymentChannelId(String paymentChannelId) {
    this.paymentChannelId = paymentChannelId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ClientPaymentChannelAddVoRes)
      return this.equals((ClientPaymentChannelAddVoRes)that);
    return false;
  }

  public boolean equals(ClientPaymentChannelAddVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ClientPaymentChannelAddVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ClientPaymentChannelAddVoRes(");
    boolean first = true;
  ...
  private static class ClientPaymentChannelAddVoResStandardSchemeFactory implements SchemeFactory {
    public ClientPaymentChannelAddVoResStandardScheme getScheme() {
      return new ClientPaymentChannelAddVoResStandardScheme();
    }
  }

  private static class ClientPaymentChannelAddVoResStandardScheme extends StandardScheme<ClientPaymentChannelAddVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ClientPaymentChannelAddVoRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClientPaymentChannelAddVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ClientPaymentChannelAddVoResTupleSchemeFactory implements SchemeFactory {
    public ClientPaymentChannelAddVoResTupleScheme getScheme() {
      return new ClientPaymentChannelAddVoResTupleScheme();
    }
  }

  private static class ClientPaymentChannelAddVoResTupleScheme extends TupleScheme<ClientPaymentChannelAddVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ClientPaymentChannelAddVoRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ClientPaymentChannelAddVoRes struct) throws org.apache.thrift.TException {
