...
public class SubOrderVo implements org.apache.thrift.TBase<SubOrderVo, SubOrderVo._Fields>, java.io.Serializable, Cloneable, Comparable<SubOrderVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SubOrderVo");
  ...
  static {
    schemes.put(StandardScheme.class, new SubOrderVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SubOrderVoTupleSchemeFactory());
  }
   ...
   * 商品
   */
  public List<ProductVo> products; // required
  /**
   * 商户ID
   */
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SubOrderVo.class, metaDataMap);
  }
   ...
   */
  public SubOrderVo(SubOrderVo other) {
    ...
    if (other.isSetProducts()) {
      List<ProductVo> __this__products = new ArrayList<ProductVo>(other.products.size());
      for (ProductVo other_element : other.products) {
        __this__products.add(new ProductVo(other_element));
      }
  ...
  public SubOrderVo deepCopy() {
    return new SubOrderVo(this);
  }
   ...
   * 商户名
   */
  public SubOrderVo setMerchantName(String merchantName) {
    this.merchantName = merchantName;
    return this;
  }
   ...
   * 子订单类型
   */
  public SubOrderVo setType(String type) {
    this.type = type;
    return this;
  }
   ...
   * 配送状态-名优特惠有值
   */
  public SubOrderVo setDeliveryState(String deliveryState) {
    this.deliveryState = deliveryState;
    return this;
  }
  ...
  public java.util.Iterator<ProductVo> getProductsIterator() {
    return (this.products == null) ? null : this.products.iterator();
  }

  public void addToProducts(ProductVo elem) {
   ...
   * 商品
   */
  public SubOrderVo setProducts(List<ProductVo> products) {
    this.products = products;
    return this;
  }
   ...
   * 商户ID
   */
  public SubOrderVo setMerchantId(String merchantId) {
    this.merchantId = merchantId;
    return this;
  }
   ...
   * 接口通用后加上名优特惠的物流信息*
   */
  public SubOrderVo setDeliveryCorpId(String deliveryCorpId) {
    this.deliveryCorpId = deliveryCorpId;
    return this;
  }
  ...
  public SubOrderVo setDeliveryCorpName(String deliveryCorpName) {
    this.deliveryCorpName = deliveryCorpName;
    return this;
  }
  ...
  public SubOrderVo setTrackingNo(String trackingNo) {
    this.trackingNo = trackingNo;
    return this;
  }
  ...
  public SubOrderVo setShippingTime(long shippingTime) {
    this.shippingTime = shippingTime;
    setShippingTimeIsSet(true);
    return this;
  }
  ...
  public SubOrderVo setSubOrderId(String subOrderId) {
    this.subOrderId = subOrderId;
    return this;
  }
   ...
   * 订单金额
   */
  public SubOrderVo setTotalPrice(double totalPrice) {
    this.totalPrice = totalPrice;
    setTotalPriceIsSet(true);
    return this;
  }
   ...
   * 订单子状态
   */
  public SubOrderVo setRefundState(String refundState) {
    this.refundState = refundState;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PRODUCTS:
      if (value == null) {
        ...
        setProducts((List<ProductVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SubOrderVo)
      return this.equals((SubOrderVo)that);
    return false;
  }

  public boolean equals(SubOrderVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SubOrderVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SubOrderVo(");
    boolean first = true;
  ...
  private static class SubOrderVoStandardSchemeFactory implements SchemeFactory {
    public SubOrderVoStandardScheme getScheme() {
      return new SubOrderVoStandardScheme();
    }
  }

  private static class SubOrderVoStandardScheme extends StandardScheme<SubOrderVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SubOrderVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.products = new ArrayList<ProductVo>(_list128.size);
                ProductVo _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new ProductVo();
                  _elem129.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SubOrderVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.products != null) {
        oprot.writeFieldBegin(PRODUCTS_FIELD_DESC);
        {
          ...
          for (ProductVo _iter131 : struct.products)
          {
  ...
  private static class SubOrderVoTupleSchemeFactory implements SchemeFactory {
    public SubOrderVoTupleScheme getScheme() {
      return new SubOrderVoTupleScheme();
    }
  }

  private static class SubOrderVoTupleScheme extends TupleScheme<SubOrderVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SubOrderVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProducts()) {
        {
          ...
          for (ProductVo _iter132 : struct.products)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SubOrderVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.products = new ArrayList<ProductVo>(_list133.size);
          ProductVo _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new ProductVo();
            _elem134.read(iprot);
            struct.products.add(_elem134);
          }
        }
        struct.setProductsIsSet(true);
      }
