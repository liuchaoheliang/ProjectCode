...
public class ResultVo implements org.apache.thrift.TBase<ResultVo, ResultVo._Fields>, java.io.Serializable, Cloneable, Comparable<ResultVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ResultVo");
  ...
  static {
    schemes.put(StandardScheme.class, new ResultVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ResultVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ResultVo.class, metaDataMap);
  }
   ...
   */
  public ResultVo(ResultVo other) {
   ...
   * 返回码 : 0000:成功 ,失败：xxxx
   */
  public ResultVo setResultCode(String resultCode) {
    this.resultCode = resultCode;
    return this;
  }
   ...
   * 返回信息
   */
  public ResultVo setResultDesc(String resultDesc) {
    this.resultDesc = resultDesc;
    return this;
  }
  ...
  public ResultVo setReqId(String reqId) {
    this.reqId = reqId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ResultVo)
      return this.equals((ResultVo)that);
    return false;
  }

  public boolean equals(ResultVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ResultVo other) {
  ...
  private static class ResultVoStandardSchemeFactory implements SchemeFactory {
    public ResultVoStandardScheme getScheme() {
      return new ResultVoStandardScheme();
    }
  }

  private static class ResultVoStandardScheme extends StandardScheme<ResultVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ResultVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResultVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ResultVoTupleSchemeFactory implements SchemeFactory {
    public ResultVoTupleScheme getScheme() {
      return new ResultVoTupleScheme();
    }
  }

  private static class ResultVoTupleScheme extends TupleScheme<ResultVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ResultVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ResultVo struct) throws org.apache.thrift.TException {
