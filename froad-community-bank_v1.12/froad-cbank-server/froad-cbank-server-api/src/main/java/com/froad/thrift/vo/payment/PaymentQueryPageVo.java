...
public class PaymentQueryPageVo implements org.apache.thrift.TBase<PaymentQueryPageVo, PaymentQueryPageVo._Fields>, java.io.Serializable, Cloneable, Comparable<PaymentQueryPageVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PaymentQueryPageVo");
  ...
  static {
    schemes.put(StandardScheme.class, new PaymentQueryPageVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PaymentQueryPageVoTupleSchemeFactory());
  }

  public com.froad.thrift.vo.PageVo pageVo; // required
  public com.froad.thrift.vo.ResultVo resultVo; // required
  public List<PaymentQueryVo> paymentQueryVos; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PAYMENT_QUERY_VOS, new org.apache.thrift.meta_data.FieldMetaData("paymentQueryVos", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "PaymentQueryVo"))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PaymentQueryPageVo.class, metaDataMap);
  }

  public PaymentQueryPageVo() {
  }

  public PaymentQueryPageVo(
    com.froad.thrift.vo.PageVo pageVo,
    com.froad.thrift.vo.ResultVo resultVo,
    List<PaymentQueryVo> paymentQueryVos)
  {
    this();
    this.pageVo = pageVo;
   ...
   */
  public PaymentQueryPageVo(PaymentQueryPageVo other) {
    ...
    if (other.isSetPaymentQueryVos()) {
      List<PaymentQueryVo> __this__paymentQueryVos = new ArrayList<PaymentQueryVo>(other.paymentQueryVos.size());
      for (PaymentQueryVo other_element : other.paymentQueryVos) {
  ...
  public PaymentQueryPageVo deepCopy() {
    return new PaymentQueryPageVo(this);
  }
  ...
  public PaymentQueryPageVo setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public PaymentQueryPageVo setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
  ...
  public java.util.Iterator<PaymentQueryVo> getPaymentQueryVosIterator() {
    return (this.paymentQueryVos == null) ? null : this.paymentQueryVos.iterator();
  }

  public void addToPaymentQueryVos(PaymentQueryVo elem) {
    if (this.paymentQueryVos == null) {
      this.paymentQueryVos = new ArrayList<PaymentQueryVo>();
    }
    this.paymentQueryVos.add(elem);
  }

  public List<PaymentQueryVo> getPaymentQueryVos() {
    return this.paymentQueryVos;
  }

  public PaymentQueryPageVo setPaymentQueryVos(List<PaymentQueryVo> paymentQueryVos) {
    this.paymentQueryVos = paymentQueryVos;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAYMENT_QUERY_VOS:
      if (value == null) {
        ...
        setPaymentQueryVos((List<PaymentQueryVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PaymentQueryPageVo)
      return this.equals((PaymentQueryPageVo)that);
    return false;
  }

  public boolean equals(PaymentQueryPageVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PaymentQueryPageVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PaymentQueryPageVo(");
    boolean first = true;
  ...
  private static class PaymentQueryPageVoStandardSchemeFactory implements SchemeFactory {
    public PaymentQueryPageVoStandardScheme getScheme() {
      return new PaymentQueryPageVoStandardScheme();
    }
  }

  private static class PaymentQueryPageVoStandardScheme extends StandardScheme<PaymentQueryPageVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PaymentQueryPageVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.paymentQueryVos = new ArrayList<PaymentQueryVo>(_list0.size);
                PaymentQueryVo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new PaymentQueryVo();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaymentQueryPageVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.paymentQueryVos != null) {
        oprot.writeFieldBegin(PAYMENT_QUERY_VOS_FIELD_DESC);
        {
          ...
          for (PaymentQueryVo _iter3 : struct.paymentQueryVos)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PaymentQueryPageVoTupleSchemeFactory implements SchemeFactory {
    public PaymentQueryPageVoTupleScheme getScheme() {
      return new PaymentQueryPageVoTupleScheme();
    }
  }

  private static class PaymentQueryPageVoTupleScheme extends TupleScheme<PaymentQueryPageVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PaymentQueryPageVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPaymentQueryVos()) {
        {
          ...
          for (PaymentQueryVo _iter4 : struct.paymentQueryVos)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PaymentQueryPageVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.paymentQueryVos = new ArrayList<PaymentQueryVo>(_list5.size);
          PaymentQueryVo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new PaymentQueryVo();
            _elem6.read(iprot);
