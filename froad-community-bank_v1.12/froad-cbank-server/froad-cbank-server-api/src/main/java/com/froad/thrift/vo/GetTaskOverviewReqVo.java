...
public class GetTaskOverviewReqVo implements org.apache.thrift.TBase<GetTaskOverviewReqVo, GetTaskOverviewReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<GetTaskOverviewReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetTaskOverviewReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new GetTaskOverviewReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetTaskOverviewReqVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetTaskOverviewReqVo.class, metaDataMap);
  }

  public GetTaskOverviewReqVo() {
  }
   ...
   */
  public GetTaskOverviewReqVo(GetTaskOverviewReqVo other) {
  ...
  public GetTaskOverviewReqVo deepCopy() {
    return new GetTaskOverviewReqVo(this);
  }
   ...
   * 源信息
   */
  public GetTaskOverviewReqVo setOrigin(com.froad.thrift.vo.OriginVo origin) {
    this.origin = origin;
    return this;
  }
   ...
   * 审核流水号
   */
  public GetTaskOverviewReqVo setInstanceId(String instanceId) {
    this.instanceId = instanceId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTaskOverviewReqVo)
      return this.equals((GetTaskOverviewReqVo)that);
    return false;
  }

  public boolean equals(GetTaskOverviewReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetTaskOverviewReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetTaskOverviewReqVo(");
    boolean first = true;
  ...
  private static class GetTaskOverviewReqVoStandardSchemeFactory implements SchemeFactory {
    public GetTaskOverviewReqVoStandardScheme getScheme() {
      return new GetTaskOverviewReqVoStandardScheme();
    }
  }

  private static class GetTaskOverviewReqVoStandardScheme extends StandardScheme<GetTaskOverviewReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetTaskOverviewReqVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetTaskOverviewReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetTaskOverviewReqVoTupleSchemeFactory implements SchemeFactory {
    public GetTaskOverviewReqVoTupleScheme getScheme() {
      return new GetTaskOverviewReqVoTupleScheme();
    }
  }

  private static class GetTaskOverviewReqVoTupleScheme extends TupleScheme<GetTaskOverviewReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetTaskOverviewReqVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetTaskOverviewReqVo struct) throws org.apache.thrift.TException {
