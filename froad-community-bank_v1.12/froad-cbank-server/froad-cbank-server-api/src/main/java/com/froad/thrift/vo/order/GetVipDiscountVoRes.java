...
public class GetVipDiscountVoRes implements org.apache.thrift.TBase<GetVipDiscountVoRes, GetVipDiscountVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<GetVipDiscountVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetVipDiscountVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new GetVipDiscountVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetVipDiscountVoResTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetVipDiscountVoRes.class, metaDataMap);
  }

  public GetVipDiscountVoRes() {
  }
   ...
   */
  public GetVipDiscountVoRes(GetVipDiscountVoRes other) {
  ...
  public GetVipDiscountVoRes deepCopy() {
    return new GetVipDiscountVoRes(this);
  }
   ...
   * 结果信息
   */
  public GetVipDiscountVoRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 支付金额
   */
  public GetVipDiscountVoRes setMoney(double money) {
    this.money = money;
    setMoneyIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetVipDiscountVoRes)
      return this.equals((GetVipDiscountVoRes)that);
    return false;
  }

  public boolean equals(GetVipDiscountVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetVipDiscountVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetVipDiscountVoRes(");
    boolean first = true;
  ...
  private static class GetVipDiscountVoResStandardSchemeFactory implements SchemeFactory {
    public GetVipDiscountVoResStandardScheme getScheme() {
      return new GetVipDiscountVoResStandardScheme();
    }
  }

  private static class GetVipDiscountVoResStandardScheme extends StandardScheme<GetVipDiscountVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetVipDiscountVoRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetVipDiscountVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetVipDiscountVoResTupleSchemeFactory implements SchemeFactory {
    public GetVipDiscountVoResTupleScheme getScheme() {
      return new GetVipDiscountVoResTupleScheme();
    }
  }

  private static class GetVipDiscountVoResTupleScheme extends TupleScheme<GetVipDiscountVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetVipDiscountVoRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetVipDiscountVoRes struct) throws org.apache.thrift.TException {
