...
public class AddOrderVoRes implements org.apache.thrift.TBase<AddOrderVoRes, AddOrderVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<AddOrderVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddOrderVoRes");
  ...
  private static final org.apache.thrift.protocol.TField MERCHANT_RETURN_VO_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("merchantReturnVoList", org.apache.thrift.protocol.TType.LIST, (short)4);
  private static final org.apache.thrift.protocol.TField VIP_DISCOUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("vipDiscount", org.apache.thrift.protocol.TType.DOUBLE, (short)5);
  private static final org.apache.thrift.protocol.TField CASH_FIELD_DESC = new org.apache.thrift.protocol.TField("cash", org.apache.thrift.protocol.TType.DOUBLE, (short)6);
  private static final org.apache.thrift.protocol.TField FROAD_POINT_FIELD_DESC = new org.apache.thrift.protocol.TField("froadPoint", org.apache.thrift.protocol.TType.DOUBLE, (short)7);
  private static final org.apache.thrift.protocol.TField BANK_POINT_FIELD_DESC = new org.apache.thrift.protocol.TField("bankPoint", org.apache.thrift.protocol.TType.I32, (short)8);
  private static final org.apache.thrift.protocol.TField IS_NEED_CASH_FIELD_DESC = new org.apache.thrift.protocol.TField("isNeedCash", org.apache.thrift.protocol.TType.STRING, (short)9);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new AddOrderVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddOrderVoResTupleSchemeFactory());
  }
   ...
   * 商户信息
   */
  public List<MerchantReturnVo> merchantReturnVoList; // required
  /**
   * VIP优惠金额
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 商户信息
     */
    MERCHANT_RETURN_VO_LIST((short)4, "merchantReturnVoList"),
    /**
     * VIP优惠金额
     */
    VIP_DISCOUNT((short)5, "vipDiscount"),
    /**
     * 现金
     */
    CASH((short)6, "cash"),
     ...
     * 方付通积分
     */
    FROAD_POINT((short)7, "froadPoint"),
    /**
     * 银行积分
     */
     ...
     * 0:不跳收银台，1：跳收银台  2：（全红包/现金券）订单已支付完成
     */
    IS_NEED_CASH((short)9, "isNeedCash");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // TOTAL_PRICE
          return TOTAL_PRICE;
        case 4: // MERCHANT_RETURN_VO_LIST
          return MERCHANT_RETURN_VO_LIST;
        case 5: // VIP_DISCOUNT
          return VIP_DISCOUNT;
        case 6: // CASH
          return CASH;
  ...
  private static final int __VIPDISCOUNT_ISSET_ID = 1;
  private static final int __CASH_ISSET_ID = 2;
  private static final int __FROADPOINT_ISSET_ID = 3;
  ...
  static {
    ...
    tmpMap.put(_Fields.MERCHANT_RETURN_VO_LIST, new org.apache.thrift.meta_data.FieldMetaData("merchantReturnVoList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MerchantReturnVo.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddOrderVoRes.class, metaDataMap);
  }

  public AddOrderVoRes() {
  }
   ...
   */
  public AddOrderVoRes(AddOrderVoRes other) {
    ...
    if (other.isSetMerchantReturnVoList()) {
      List<MerchantReturnVo> __this__merchantReturnVoList = new ArrayList<MerchantReturnVo>(other.merchantReturnVoList.size());
      for (MerchantReturnVo other_element : other.merchantReturnVoList) {
        __this__merchantReturnVoList.add(new MerchantReturnVo(other_element));
      }
      this.merchantReturnVoList = __this__merchantReturnVoList;
    }
  ...
  public AddOrderVoRes deepCopy() {
    return new AddOrderVoRes(this);
  }
  ...
  public void clear() {
    ...
    this.totalPrice = 0.0;
    this.merchantReturnVoList = null;
   ...
   * 结果信息
   */
  public AddOrderVoRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 订单ID
   */
  public AddOrderVoRes setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 总金额
   */
  public AddOrderVoRes setTotalPrice(double totalPrice) {
    this.totalPrice = totalPrice;
    setTotalPriceIsSet(true);
    return this;
  }
  ...
  public int getMerchantReturnVoListSize() {
    return (this.merchantReturnVoList == null) ? 0 : this.merchantReturnVoList.size();
  }

  public java.util.Iterator<MerchantReturnVo> getMerchantReturnVoListIterator() {
    return (this.merchantReturnVoList == null) ? null : this.merchantReturnVoList.iterator();
  }

  public void addToMerchantReturnVoList(MerchantReturnVo elem) {
    if (this.merchantReturnVoList == null) {
      this.merchantReturnVoList = new ArrayList<MerchantReturnVo>();
    }
    this.merchantReturnVoList.add(elem);
  }
  ...
  public List<MerchantReturnVo> getMerchantReturnVoList() {
    return this.merchantReturnVoList;
  }

  /**
   * 商户信息
   */
  public AddOrderVoRes setMerchantReturnVoList(List<MerchantReturnVo> merchantReturnVoList) {
    this.merchantReturnVoList = merchantReturnVoList;
    return this;
  }

  public void unsetMerchantReturnVoList() {
    this.merchantReturnVoList = null;
  }

  /** Returns true if field merchantReturnVoList is set (has been assigned a value) and false otherwise */
  public boolean isSetMerchantReturnVoList() {
    return this.merchantReturnVoList != null;
  }

  public void setMerchantReturnVoListIsSet(boolean value) {
    if (!value) {
      this.merchantReturnVoList = null;
    }
  }
   ...
   * VIP优惠金额
   */
  public AddOrderVoRes setVipDiscount(double vipDiscount) {
    this.vipDiscount = vipDiscount;
    setVipDiscountIsSet(true);
    return this;
  }
   ...
   * 现金
   */
  public AddOrderVoRes setCash(double cash) {
    this.cash = cash;
    setCashIsSet(true);
    return this;
  }
   ...
   * 方付通积分
   */
  public AddOrderVoRes setFroadPoint(double froadPoint) {
    this.froadPoint = froadPoint;
    setFroadPointIsSet(true);
    return this;
  }
   ...
   * 银行积分
   */
  public AddOrderVoRes setBankPoint(int bankPoint) {
    this.bankPoint = bankPoint;
    setBankPointIsSet(true);
    return this;
  }
   ...
   * 0:不跳收银台，1：跳收银台  2：（全红包/现金券）订单已支付完成
   */
  public AddOrderVoRes setIsNeedCash(String isNeedCash) {
    this.isNeedCash = isNeedCash;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MERCHANT_RETURN_VO_LIST:
      if (value == null) {
        unsetMerchantReturnVoList();
      } else {
        setMerchantReturnVoList((List<MerchantReturnVo>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case MERCHANT_RETURN_VO_LIST:
      return getMerchantReturnVoList();
  ...
  public boolean isSet(_Fields field) {
    ...
    case MERCHANT_RETURN_VO_LIST:
      return isSetMerchantReturnVoList();
    case VIP_DISCOUNT:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddOrderVoRes)
      return this.equals((AddOrderVoRes)that);
    return false;
  }

  public boolean equals(AddOrderVoRes that) {
    if (that == null)
      return false;
    ...
    boolean this_present_merchantReturnVoList = true && this.isSetMerchantReturnVoList();
    boolean that_present_merchantReturnVoList = true && that.isSetMerchantReturnVoList();
    if (this_present_merchantReturnVoList || that_present_merchantReturnVoList) {
      if (!(this_present_merchantReturnVoList && that_present_merchantReturnVoList))
        return false;
      if (!this.merchantReturnVoList.equals(that.merchantReturnVoList))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_merchantReturnVoList = true && (isSetMerchantReturnVoList());
    list.add(present_merchantReturnVoList);
    if (present_merchantReturnVoList)
      list.add(merchantReturnVoList);
  ...
  @Override
  public int compareTo(AddOrderVoRes other) {
    ...
    lastComparison = Boolean.valueOf(isSetMerchantReturnVoList()).compareTo(other.isSetMerchantReturnVoList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMerchantReturnVoList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.merchantReturnVoList, other.merchantReturnVoList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddOrderVoRes(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("merchantReturnVoList:");
    if (this.merchantReturnVoList == null) {
      sb.append("null");
    } else {
      sb.append(this.merchantReturnVoList);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class AddOrderVoResStandardSchemeFactory implements SchemeFactory {
    public AddOrderVoResStandardScheme getScheme() {
      return new AddOrderVoResStandardScheme();
    }
  }

  private static class AddOrderVoResStandardScheme extends StandardScheme<AddOrderVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddOrderVoRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.merchantReturnVoList = new ArrayList<MerchantReturnVo>(_list48.size);
                MerchantReturnVo _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new MerchantReturnVo();
                  _elem49.read(iprot);
                  struct.merchantReturnVoList.add(_elem49);
                }
                iprot.readListEnd();
              }
              struct.setMerchantReturnVoListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddOrderVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      if (struct.merchantReturnVoList != null) {
        oprot.writeFieldBegin(MERCHANT_RETURN_VO_LIST_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.merchantReturnVoList.size()));
          for (MerchantReturnVo _iter51 : struct.merchantReturnVoList)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class AddOrderVoResTupleSchemeFactory implements SchemeFactory {
    public AddOrderVoResTupleScheme getScheme() {
      return new AddOrderVoResTupleScheme();
    }
  }

  private static class AddOrderVoResTupleScheme extends TupleScheme<AddOrderVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddOrderVoRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMerchantReturnVoList()) {
        optionals.set(3);
      }
      ...
      if (struct.isSetMerchantReturnVoList()) {
        {
          oprot.writeI32(struct.merchantReturnVoList.size());
          for (MerchantReturnVo _iter52 : struct.merchantReturnVoList)
          {
            _iter52.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddOrderVoRes struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.merchantReturnVoList = new ArrayList<MerchantReturnVo>(_list53.size);
          MerchantReturnVo _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = new MerchantReturnVo();
            _elem54.read(iprot);
            struct.merchantReturnVoList.add(_elem54);
          }
        }
        struct.setMerchantReturnVoListIsSet(true);
      }
