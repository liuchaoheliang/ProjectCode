...
public class GroupOrderListRes implements org.apache.thrift.TBase<GroupOrderListRes, GroupOrderListRes._Fields>, java.io.Serializable, Cloneable, Comparable<GroupOrderListRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GroupOrderListRes");
  ...
  static {
    schemes.put(StandardScheme.class, new GroupOrderListResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GroupOrderListResTupleSchemeFactory());
  }

  /**
   * 订单数据
   */
  public List<GroupOrderVo> orders; // required
  /**
   * 查询结果
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.ORDERS, new org.apache.thrift.meta_data.FieldMetaData("orders", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "GroupOrderVo"))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GroupOrderListRes.class, metaDataMap);
  }

  public GroupOrderListRes() {
  }

  public GroupOrderListRes(
    List<GroupOrderVo> orders,
   ...
   */
  public GroupOrderListRes(GroupOrderListRes other) {
    if (other.isSetOrders()) {
      List<GroupOrderVo> __this__orders = new ArrayList<GroupOrderVo>(other.orders.size());
      for (GroupOrderVo other_element : other.orders) {
  ...
  public GroupOrderListRes deepCopy() {
    return new GroupOrderListRes(this);
  }
  ...
  public java.util.Iterator<GroupOrderVo> getOrdersIterator() {
    return (this.orders == null) ? null : this.orders.iterator();
  }

  public void addToOrders(GroupOrderVo elem) {
    if (this.orders == null) {
      this.orders = new ArrayList<GroupOrderVo>();
    }
   ...
   * 订单数据
   */
  public List<GroupOrderVo> getOrders() {
    return this.orders;
  }
   ...
   * 订单数据
   */
  public GroupOrderListRes setOrders(List<GroupOrderVo> orders) {
    this.orders = orders;
    return this;
  }
   ...
   * 查询结果
   */
  public GroupOrderListRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 分页数据
   */
  public GroupOrderListRes setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ORDERS:
      if (value == null) {
        ...
        setOrders((List<GroupOrderVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GroupOrderListRes)
      return this.equals((GroupOrderListRes)that);
    return false;
  }

  public boolean equals(GroupOrderListRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GroupOrderListRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GroupOrderListRes(");
    boolean first = true;
  ...
  private static class GroupOrderListResStandardSchemeFactory implements SchemeFactory {
    public GroupOrderListResStandardScheme getScheme() {
      return new GroupOrderListResStandardScheme();
    }
  }

  private static class GroupOrderListResStandardScheme extends StandardScheme<GroupOrderListRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GroupOrderListRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orders = new ArrayList<GroupOrderVo>(_list0.size);
                GroupOrderVo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new GroupOrderVo();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GroupOrderListRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.orders != null) {
        oprot.writeFieldBegin(ORDERS_FIELD_DESC);
        {
          ...
          for (GroupOrderVo _iter3 : struct.orders)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class GroupOrderListResTupleSchemeFactory implements SchemeFactory {
    public GroupOrderListResTupleScheme getScheme() {
      return new GroupOrderListResTupleScheme();
    }
  }

  private static class GroupOrderListResTupleScheme extends TupleScheme<GroupOrderListRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GroupOrderListRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOrders()) {
        {
          ...
          for (GroupOrderVo _iter4 : struct.orders)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GroupOrderListRes struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list5 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.orders = new ArrayList<GroupOrderVo>(_list5.size);
          GroupOrderVo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new GroupOrderVo();
            _elem6.read(iprot);
