...
public class CheckVIPExistWhiteListReqVo implements org.apache.thrift.TBase<CheckVIPExistWhiteListReqVo, CheckVIPExistWhiteListReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<CheckVIPExistWhiteListReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CheckVIPExistWhiteListReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new CheckVIPExistWhiteListReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CheckVIPExistWhiteListReqVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CheckVIPExistWhiteListReqVo.class, metaDataMap);
  }

  public CheckVIPExistWhiteListReqVo() {
  }
   ...
   */
  public CheckVIPExistWhiteListReqVo(CheckVIPExistWhiteListReqVo other) {
  ...
  public CheckVIPExistWhiteListReqVo deepCopy() {
    return new CheckVIPExistWhiteListReqVo(this);
  }
   ...
   * 源对象信息
   */
  public CheckVIPExistWhiteListReqVo setOrigin(com.froad.thrift.vo.OriginVo origin) {
    this.origin = origin;
    return this;
  }
   ...
   * 会员编号
   */
  public CheckVIPExistWhiteListReqVo setMemberCode(long memberCode) {
    this.memberCode = memberCode;
    setMemberCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CheckVIPExistWhiteListReqVo)
      return this.equals((CheckVIPExistWhiteListReqVo)that);
    return false;
  }

  public boolean equals(CheckVIPExistWhiteListReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CheckVIPExistWhiteListReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CheckVIPExistWhiteListReqVo(");
    boolean first = true;
  ...
  private static class CheckVIPExistWhiteListReqVoStandardSchemeFactory implements SchemeFactory {
    public CheckVIPExistWhiteListReqVoStandardScheme getScheme() {
      return new CheckVIPExistWhiteListReqVoStandardScheme();
    }
  }

  private static class CheckVIPExistWhiteListReqVoStandardScheme extends StandardScheme<CheckVIPExistWhiteListReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CheckVIPExistWhiteListReqVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CheckVIPExistWhiteListReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CheckVIPExistWhiteListReqVoTupleSchemeFactory implements SchemeFactory {
    public CheckVIPExistWhiteListReqVoTupleScheme getScheme() {
      return new CheckVIPExistWhiteListReqVoTupleScheme();
    }
  }

  private static class CheckVIPExistWhiteListReqVoTupleScheme extends TupleScheme<CheckVIPExistWhiteListReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CheckVIPExistWhiteListReqVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CheckVIPExistWhiteListReqVo struct) throws org.apache.thrift.TException {
