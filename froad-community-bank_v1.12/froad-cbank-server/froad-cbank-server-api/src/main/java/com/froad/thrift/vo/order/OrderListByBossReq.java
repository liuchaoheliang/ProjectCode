...
public class OrderListByBossReq implements org.apache.thrift.TBase<OrderListByBossReq, OrderListByBossReq._Fields>, java.io.Serializable, Cloneable, Comparable<OrderListByBossReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrderListByBossReq");
  ...
  static {
    schemes.put(StandardScheme.class, new OrderListByBossReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrderListByBossReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrderListByBossReq.class, metaDataMap);
  }

  public OrderListByBossReq() {
  }
   ...
   */
  public OrderListByBossReq(OrderListByBossReq other) {
  ...
  public OrderListByBossReq deepCopy() {
    return new OrderListByBossReq(this);
  }
   ...
   * 订单编号
   */
  public OrderListByBossReq setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 支付编号
   */
  public OrderListByBossReq setPaymentId(String paymentId) {
    this.paymentId = paymentId;
    return this;
  }
   ...
   * 用户编号
   */
  public OrderListByBossReq setMemberCode(long memberCode) {
    this.memberCode = memberCode;
    setMemberCodeIsSet(true);
    return this;
  }
   ...
   * 提货手机号
   */
  public OrderListByBossReq setPhone(String phone) {
    this.phone = phone;
    return this;
  }
   ...
   * 订单来源
   */
  public OrderListByBossReq setCreateSource(String createSource) {
    this.createSource = createSource;
    return this;
  }
   ...
   * 订单状态
   */
  public OrderListByBossReq setOrderStatus(String orderStatus) {
    this.orderStatus = orderStatus;
    return this;
  }
   ...
   * 支付方式
   */
  public OrderListByBossReq setPaymentMethod(String paymentMethod) {
    this.paymentMethod = paymentMethod;
    return this;
  }
   ...
   * 所属客户端
   */
  public OrderListByBossReq setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
   ...
   * 开始时间
   */
  public OrderListByBossReq setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
   ...
   * 结束时间
   */
  public OrderListByBossReq setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
   ...
   * 分页
   */
  public OrderListByBossReq setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrderListByBossReq)
      return this.equals((OrderListByBossReq)that);
    return false;
  }

  public boolean equals(OrderListByBossReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OrderListByBossReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrderListByBossReq(");
    boolean first = true;
  ...
  private static class OrderListByBossReqStandardSchemeFactory implements SchemeFactory {
    public OrderListByBossReqStandardScheme getScheme() {
      return new OrderListByBossReqStandardScheme();
    }
  }

  private static class OrderListByBossReqStandardScheme extends StandardScheme<OrderListByBossReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrderListByBossReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrderListByBossReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OrderListByBossReqTupleSchemeFactory implements SchemeFactory {
    public OrderListByBossReqTupleScheme getScheme() {
      return new OrderListByBossReqTupleScheme();
    }
  }

  private static class OrderListByBossReqTupleScheme extends TupleScheme<OrderListByBossReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrderListByBossReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrderListByBossReq struct) throws org.apache.thrift.TException {
