...
public class AddOrderForSeckillVoRes implements org.apache.thrift.TBase<AddOrderForSeckillVoRes, AddOrderForSeckillVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<AddOrderForSeckillVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddOrderForSeckillVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new AddOrderForSeckillVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddOrderForSeckillVoResTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddOrderForSeckillVoRes.class, metaDataMap);
  }

  public AddOrderForSeckillVoRes() {
  }
   ...
   */
  public AddOrderForSeckillVoRes(AddOrderForSeckillVoRes other) {
  ...
  public AddOrderForSeckillVoRes deepCopy() {
    return new AddOrderForSeckillVoRes(this);
  }
   ...
   * 返回码 : 0000:成功 ,失败：9999
   */
  public AddOrderForSeckillVoRes setResultCode(String resultCode) {
    this.resultCode = resultCode;
    return this;
  }
   ...
   * 结果码描述信息
   */
  public AddOrderForSeckillVoRes setResultDesc(String resultDesc) {
    this.resultDesc = resultDesc;
    return this;
  }
   ...
   * 订单号
   */
  public AddOrderForSeckillVoRes setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddOrderForSeckillVoRes)
      return this.equals((AddOrderForSeckillVoRes)that);
    return false;
  }

  public boolean equals(AddOrderForSeckillVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddOrderForSeckillVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddOrderForSeckillVoRes(");
    boolean first = true;
  ...
  private static class AddOrderForSeckillVoResStandardSchemeFactory implements SchemeFactory {
    public AddOrderForSeckillVoResStandardScheme getScheme() {
      return new AddOrderForSeckillVoResStandardScheme();
    }
  }

  private static class AddOrderForSeckillVoResStandardScheme extends StandardScheme<AddOrderForSeckillVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddOrderForSeckillVoRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddOrderForSeckillVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AddOrderForSeckillVoResTupleSchemeFactory implements SchemeFactory {
    public AddOrderForSeckillVoResTupleScheme getScheme() {
      return new AddOrderForSeckillVoResTupleScheme();
    }
  }

  private static class AddOrderForSeckillVoResTupleScheme extends TupleScheme<AddOrderForSeckillVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddOrderForSeckillVoRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddOrderForSeckillVoRes struct) throws org.apache.thrift.TException {
