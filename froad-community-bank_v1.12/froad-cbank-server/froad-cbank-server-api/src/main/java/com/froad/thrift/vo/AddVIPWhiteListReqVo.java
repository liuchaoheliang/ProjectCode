...
public class AddVIPWhiteListReqVo implements org.apache.thrift.TBase<AddVIPWhiteListReqVo, AddVIPWhiteListReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<AddVIPWhiteListReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddVIPWhiteListReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new AddVIPWhiteListReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddVIPWhiteListReqVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddVIPWhiteListReqVo.class, metaDataMap);
  }

  public AddVIPWhiteListReqVo() {
  }
   ...
   */
  public AddVIPWhiteListReqVo(AddVIPWhiteListReqVo other) {
  ...
  public AddVIPWhiteListReqVo deepCopy() {
    return new AddVIPWhiteListReqVo(this);
  }
   ...
   * 源对象信息
   */
  public AddVIPWhiteListReqVo setOrigin(com.froad.thrift.vo.OriginVo origin) {
    this.origin = origin;
    return this;
  }
   ...
   * 会员编号
   */
  public AddVIPWhiteListReqVo setMemberCode(List<Long> memberCode) {
    this.memberCode = memberCode;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddVIPWhiteListReqVo)
      return this.equals((AddVIPWhiteListReqVo)that);
    return false;
  }

  public boolean equals(AddVIPWhiteListReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddVIPWhiteListReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddVIPWhiteListReqVo(");
    boolean first = true;
  ...
  private static class AddVIPWhiteListReqVoStandardSchemeFactory implements SchemeFactory {
    public AddVIPWhiteListReqVoStandardScheme getScheme() {
      return new AddVIPWhiteListReqVoStandardScheme();
    }
  }

  private static class AddVIPWhiteListReqVoStandardScheme extends StandardScheme<AddVIPWhiteListReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddVIPWhiteListReqVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.memberCode = new ArrayList<Long>(_list0.size);
                long _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readI64();
                  struct.memberCode.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddVIPWhiteListReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.memberCode != null) {
        oprot.writeFieldBegin(MEMBER_CODE_FIELD_DESC);
        {
          ...
          for (long _iter3 : struct.memberCode)
          {
  ...
  private static class AddVIPWhiteListReqVoTupleSchemeFactory implements SchemeFactory {
    public AddVIPWhiteListReqVoTupleScheme getScheme() {
      return new AddVIPWhiteListReqVoTupleScheme();
    }
  }

  private static class AddVIPWhiteListReqVoTupleScheme extends TupleScheme<AddVIPWhiteListReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddVIPWhiteListReqVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMemberCode()) {
        {
          ...
          for (long _iter4 : struct.memberCode)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddVIPWhiteListReqVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.memberCode = new ArrayList<Long>(_list5.size);
          long _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readI64();
            struct.memberCode.add(_elem6);
          }
        }
        struct.setMemberCodeIsSet(true);
      }
