...
public class AddQrcodeOrderVoRes implements org.apache.thrift.TBase<AddQrcodeOrderVoRes, AddQrcodeOrderVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<AddQrcodeOrderVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddQrcodeOrderVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new AddQrcodeOrderVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddQrcodeOrderVoResTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddQrcodeOrderVoRes.class, metaDataMap);
  }

  public AddQrcodeOrderVoRes() {
  }
   ...
   */
  public AddQrcodeOrderVoRes(AddQrcodeOrderVoRes other) {
  ...
  public AddQrcodeOrderVoRes deepCopy() {
    return new AddQrcodeOrderVoRes(this);
  }
   ...
   * 结果信息
   */
  public AddQrcodeOrderVoRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 订单ID
   */
  public AddQrcodeOrderVoRes setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 商户号
   */
  public AddQrcodeOrderVoRes setMerchantId(String merchantId) {
    this.merchantId = merchantId;
    return this;
  }
   ...
   * 商户名称
   */
  public AddQrcodeOrderVoRes setMerchantName(String merchantName) {
    this.merchantName = merchantName;
    return this;
  }
   ...
   * 支付金额
   */
  public AddQrcodeOrderVoRes setCost(double cost) {
    this.cost = cost;
    setCostIsSet(true);
    return this;
  }
   ...
   * 备注
   */
  public AddQrcodeOrderVoRes setRemark(String remark) {
    this.remark = remark;
    return this;
  }
   ...
   * 0:不跳收银台，1：跳收银台  2：（全红包/现金券）订单已支付完成
   */
  public AddQrcodeOrderVoRes setIsNeedCash(String isNeedCash) {
    this.isNeedCash = isNeedCash;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddQrcodeOrderVoRes)
      return this.equals((AddQrcodeOrderVoRes)that);
    return false;
  }

  public boolean equals(AddQrcodeOrderVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddQrcodeOrderVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddQrcodeOrderVoRes(");
    boolean first = true;
  ...
  private static class AddQrcodeOrderVoResStandardSchemeFactory implements SchemeFactory {
    public AddQrcodeOrderVoResStandardScheme getScheme() {
      return new AddQrcodeOrderVoResStandardScheme();
    }
  }

  private static class AddQrcodeOrderVoResStandardScheme extends StandardScheme<AddQrcodeOrderVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddQrcodeOrderVoRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddQrcodeOrderVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AddQrcodeOrderVoResTupleSchemeFactory implements SchemeFactory {
    public AddQrcodeOrderVoResTupleScheme getScheme() {
      return new AddQrcodeOrderVoResTupleScheme();
    }
  }

  private static class AddQrcodeOrderVoResTupleScheme extends TupleScheme<AddQrcodeOrderVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddQrcodeOrderVoRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddQrcodeOrderVoRes struct) throws org.apache.thrift.TException {
