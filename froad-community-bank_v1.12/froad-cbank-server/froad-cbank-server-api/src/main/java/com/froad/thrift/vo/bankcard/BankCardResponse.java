...
public class BankCardResponse implements org.apache.thrift.TBase<BankCardResponse, BankCardResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BankCardResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BankCardResponse");
  ...
  private static final org.apache.thrift.protocol.TField CARD_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("cardList", org.apache.thrift.protocol.TType.LIST, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new BankCardResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BankCardResponseTupleSchemeFactory());
  }

  public String resultCode; // required
  public String resultDesc; // required
  public List<BankCardInfo> cardList; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    RESULT_CODE((short)1, "resultCode"),
    RESULT_DESC((short)2, "resultDesc"),
    CARD_LIST((short)3, "cardList");
  ...
  static {
    ...
    tmpMap.put(_Fields.CARD_LIST, new org.apache.thrift.meta_data.FieldMetaData("cardList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BankCardInfo.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BankCardResponse.class, metaDataMap);
  }
   ...
   */
  public BankCardResponse(BankCardResponse other) {
    ...
    if (other.isSetCardList()) {
      List<BankCardInfo> __this__cardList = new ArrayList<BankCardInfo>(other.cardList.size());
      for (BankCardInfo other_element : other.cardList) {
        __this__cardList.add(new BankCardInfo(other_element));
      }
      this.cardList = __this__cardList;
    }
  }

  public BankCardResponse deepCopy() {
    return new BankCardResponse(this);
  }
  ...
  public BankCardResponse setResultCode(String resultCode) {
    this.resultCode = resultCode;
    return this;
  }
  ...
  public BankCardResponse setResultDesc(String resultDesc) {
    this.resultDesc = resultDesc;
    return this;
  }
  ...
  public java.util.Iterator<BankCardInfo> getCardListIterator() {
    return (this.cardList == null) ? null : this.cardList.iterator();
  }

  public void addToCardList(BankCardInfo elem) {
    if (this.cardList == null) {
      this.cardList = new ArrayList<BankCardInfo>();
    }
  ...
  public BankCardResponse setCardList(List<BankCardInfo> cardList) {
    this.cardList = cardList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CARD_LIST:
      if (value == null) {
        ...
        setCardList((List<BankCardInfo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BankCardResponse)
      return this.equals((BankCardResponse)that);
    return false;
  }

  public boolean equals(BankCardResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BankCardResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BankCardResponse(");
    boolean first = true;
  ...
  private static class BankCardResponseStandardSchemeFactory implements SchemeFactory {
    public BankCardResponseStandardScheme getScheme() {
      return new BankCardResponseStandardScheme();
    }
  }

  private static class BankCardResponseStandardScheme extends StandardScheme<BankCardResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BankCardResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cardList = new ArrayList<BankCardInfo>(_list0.size);
                BankCardInfo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new BankCardInfo();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BankCardResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.cardList != null) {
        oprot.writeFieldBegin(CARD_LIST_FIELD_DESC);
        {
          ...
          for (BankCardInfo _iter3 : struct.cardList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class BankCardResponseTupleSchemeFactory implements SchemeFactory {
    public BankCardResponseTupleScheme getScheme() {
      return new BankCardResponseTupleScheme();
    }
  }

  private static class BankCardResponseTupleScheme extends TupleScheme<BankCardResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BankCardResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCardList()) {
        {
          ...
          for (BankCardInfo _iter4 : struct.cardList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BankCardResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.cardList = new ArrayList<BankCardInfo>(_list5.size);
          BankCardInfo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new BankCardInfo();
            _elem6.read(iprot);
