...
public class TicketListResponseVo implements org.apache.thrift.TBase<TicketListResponseVo, TicketListResponseVo._Fields>, java.io.Serializable, Cloneable, Comparable<TicketListResponseVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TicketListResponseVo");
  ...
  static {
    schemes.put(StandardScheme.class, new TicketListResponseVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TicketListResponseVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TicketListResponseVo.class, metaDataMap);
  }

  public TicketListResponseVo() {
  }
   ...
   */
  public TicketListResponseVo(TicketListResponseVo other) {
  ...
  public TicketListResponseVo deepCopy() {
    return new TicketListResponseVo(this);
  }
   ...
   * 返回结果
   */
  public TicketListResponseVo setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 商品类型
   */
  public TicketListResponseVo setTicketDetailList(List<TicketDetailVo> ticketDetailList) {
    this.ticketDetailList = ticketDetailList;
    return this;
  }
   ...
   * 分页信息
   */
  public TicketListResponseVo setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TicketListResponseVo)
      return this.equals((TicketListResponseVo)that);
    return false;
  }

  public boolean equals(TicketListResponseVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TicketListResponseVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TicketListResponseVo(");
    boolean first = true;
  ...
  private static class TicketListResponseVoStandardSchemeFactory implements SchemeFactory {
    public TicketListResponseVoStandardScheme getScheme() {
      return new TicketListResponseVoStandardScheme();
    }
  }

  private static class TicketListResponseVoStandardScheme extends StandardScheme<TicketListResponseVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TicketListResponseVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ticketDetailList = new ArrayList<TicketDetailVo>(_list64.size);
                TicketDetailVo _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new TicketDetailVo();
                  _elem65.read(iprot);
                  struct.ticketDetailList.add(_elem65);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TicketListResponseVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ticketDetailList != null) {
        oprot.writeFieldBegin(TICKET_DETAIL_LIST_FIELD_DESC);
        {
          ...
          for (TicketDetailVo _iter67 : struct.ticketDetailList)
          {
            _iter67.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TicketListResponseVoTupleSchemeFactory implements SchemeFactory {
    public TicketListResponseVoTupleScheme getScheme() {
      return new TicketListResponseVoTupleScheme();
    }
  }

  private static class TicketListResponseVoTupleScheme extends TupleScheme<TicketListResponseVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TicketListResponseVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetTicketDetailList()) {
        {
          ...
          for (TicketDetailVo _iter68 : struct.ticketDetailList)
          {
            _iter68.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TicketListResponseVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.ticketDetailList = new ArrayList<TicketDetailVo>(_list69.size);
          TicketDetailVo _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new TicketDetailVo();
            _elem70.read(iprot);
            struct.ticketDetailList.add(_elem70);
          }
        }
        struct.setTicketDetailListIsSet(true);
      }
