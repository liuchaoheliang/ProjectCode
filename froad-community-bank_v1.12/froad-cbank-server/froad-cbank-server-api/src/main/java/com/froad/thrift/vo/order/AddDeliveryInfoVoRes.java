...
public class AddDeliveryInfoVoRes implements org.apache.thrift.TBase<AddDeliveryInfoVoRes, AddDeliveryInfoVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<AddDeliveryInfoVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddDeliveryInfoVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new AddDeliveryInfoVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddDeliveryInfoVoResTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddDeliveryInfoVoRes.class, metaDataMap);
  }

  public AddDeliveryInfoVoRes() {
  }
   ...
   */
  public AddDeliveryInfoVoRes(AddDeliveryInfoVoRes other) {
  ...
  public AddDeliveryInfoVoRes deepCopy() {
    return new AddDeliveryInfoVoRes(this);
  }
   ...
   * 返回码 : 0000:成功 ,失败：9999
   */
  public AddDeliveryInfoVoRes setResultCode(String resultCode) {
    this.resultCode = resultCode;
    return this;
  }
   ...
   * 结果码描述信息
   */
  public AddDeliveryInfoVoRes setResultDesc(String resultDesc) {
    this.resultDesc = resultDesc;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddDeliveryInfoVoRes)
      return this.equals((AddDeliveryInfoVoRes)that);
    return false;
  }

  public boolean equals(AddDeliveryInfoVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddDeliveryInfoVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddDeliveryInfoVoRes(");
    boolean first = true;
  ...
  private static class AddDeliveryInfoVoResStandardSchemeFactory implements SchemeFactory {
    public AddDeliveryInfoVoResStandardScheme getScheme() {
      return new AddDeliveryInfoVoResStandardScheme();
    }
  }

  private static class AddDeliveryInfoVoResStandardScheme extends StandardScheme<AddDeliveryInfoVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddDeliveryInfoVoRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddDeliveryInfoVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AddDeliveryInfoVoResTupleSchemeFactory implements SchemeFactory {
    public AddDeliveryInfoVoResTupleScheme getScheme() {
      return new AddDeliveryInfoVoResTupleScheme();
    }
  }

  private static class AddDeliveryInfoVoResTupleScheme extends TupleScheme<AddDeliveryInfoVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddDeliveryInfoVoRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddDeliveryInfoVoRes struct) throws org.apache.thrift.TException {
