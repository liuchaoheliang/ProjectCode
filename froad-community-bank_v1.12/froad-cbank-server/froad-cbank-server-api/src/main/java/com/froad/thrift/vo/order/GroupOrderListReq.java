...
public class GroupOrderListReq implements org.apache.thrift.TBase<GroupOrderListReq, GroupOrderListReq._Fields>, java.io.Serializable, Cloneable, Comparable<GroupOrderListReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GroupOrderListReq");
  ...
  static {
    schemes.put(StandardScheme.class, new GroupOrderListReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GroupOrderListReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GroupOrderListReq.class, metaDataMap);
  }

  public GroupOrderListReq() {
  }
   ...
   */
  public GroupOrderListReq(GroupOrderListReq other) {
  ...
  public GroupOrderListReq deepCopy() {
    return new GroupOrderListReq(this);
  }
   ...
   * 订单编号
   */
  public GroupOrderListReq setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 手机号
   */
  public GroupOrderListReq setPhone(String phone) {
    this.phone = phone;
    return this;
  }
   ...
   * 券号状态:0:待发送;1:已发送;2:已消费;3:已过期;4:已退款;5:退款中;6:退款失败;7:已过期退款;8:未发码退款;9:已过期退款中
   */
  public GroupOrderListReq setTicketStatus(String ticketStatus) {
    this.ticketStatus = ticketStatus;
    return this;
  }
   ...
   * 结算状态0:未结算;1:结算中;2:结算成功;3:结算失败;4:无效结算记录
   */
  public GroupOrderListReq setSettlementStatus(String settlementStatus) {
    this.settlementStatus = settlementStatus;
    return this;
  }
   ...
   * 商品名称
   */
  public GroupOrderListReq setProductName(String productName) {
    this.productName = productName;
    return this;
  }
   ...
   * 用户名称:登录账号
   */
  public GroupOrderListReq setMemberName(String memberName) {
    this.memberName = memberName;
    return this;
  }
   ...
   * 开始时间
   */
  public GroupOrderListReq setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
   ...
   * 结束时间
   */
  public GroupOrderListReq setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
   ...
   * 分页
   */
  public GroupOrderListReq setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GroupOrderListReq)
      return this.equals((GroupOrderListReq)that);
    return false;
  }

  public boolean equals(GroupOrderListReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GroupOrderListReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GroupOrderListReq(");
    boolean first = true;
  ...
  private static class GroupOrderListReqStandardSchemeFactory implements SchemeFactory {
    public GroupOrderListReqStandardScheme getScheme() {
      return new GroupOrderListReqStandardScheme();
    }
  }

  private static class GroupOrderListReqStandardScheme extends StandardScheme<GroupOrderListReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GroupOrderListReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GroupOrderListReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GroupOrderListReqTupleSchemeFactory implements SchemeFactory {
    public GroupOrderListReqTupleScheme getScheme() {
      return new GroupOrderListReqTupleScheme();
    }
  }

  private static class GroupOrderListReqTupleScheme extends TupleScheme<GroupOrderListReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GroupOrderListReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GroupOrderListReq struct) throws org.apache.thrift.TException {
