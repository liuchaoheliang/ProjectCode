...
public class FindActiveRuleByProductVo implements org.apache.thrift.TBase<FindActiveRuleByProductVo, FindActiveRuleByProductVo._Fields>, java.io.Serializable, Cloneable, Comparable<FindActiveRuleByProductVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FindActiveRuleByProductVo");
  ...
  private static final org.apache.thrift.protocol.TField PRODUCT_ID_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("productIdList", org.apache.thrift.protocol.TType.LIST, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new FindActiveRuleByProductVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FindActiveRuleByProductVoTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 商品id - 列表
     */
    PRODUCT_ID_LIST((short)4, "productIdList");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FindActiveRuleByProductVo.class, metaDataMap);
  }

  public FindActiveRuleByProductVo() {
  }
   ...
   */
  public FindActiveRuleByProductVo(FindActiveRuleByProductVo other) {
    if (other.isSetReqId()) {
  ...
  public FindActiveRuleByProductVo deepCopy() {
    return new FindActiveRuleByProductVo(this);
  }
   ...
   * 请求id
   */
  public FindActiveRuleByProductVo setReqId(String reqId) {
    this.reqId = reqId;
    return this;
  }
   ...
   * 客户端id
   */
  public FindActiveRuleByProductVo setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
   ...
   * 客户号 *
   */
  public FindActiveRuleByProductVo setMemberCode(String memberCode) {
    this.memberCode = memberCode;
    return this;
  }
   ...
   * 商品id - 列表
   */
  public FindActiveRuleByProductVo setProductIdList(List<String> productIdList) {
    this.productIdList = productIdList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FindActiveRuleByProductVo)
      return this.equals((FindActiveRuleByProductVo)that);
    return false;
  }

  public boolean equals(FindActiveRuleByProductVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FindActiveRuleByProductVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FindActiveRuleByProductVo(");
    boolean first = true;
  ...
  private static class FindActiveRuleByProductVoStandardSchemeFactory implements SchemeFactory {
    public FindActiveRuleByProductVoStandardScheme getScheme() {
      return new FindActiveRuleByProductVoStandardScheme();
    }
  }

  private static class FindActiveRuleByProductVoStandardScheme extends StandardScheme<FindActiveRuleByProductVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FindActiveRuleByProductVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productIdList = new ArrayList<String>(_list216.size);
                String _elem217;
                for (int _i218 = 0; _i218 < _list216.size; ++_i218)
                {
                  _elem217 = iprot.readString();
                  struct.productIdList.add(_elem217);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindActiveRuleByProductVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.productIdList != null) {
        oprot.writeFieldBegin(PRODUCT_ID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter219 : struct.productIdList)
          {
  ...
  private static class FindActiveRuleByProductVoTupleSchemeFactory implements SchemeFactory {
    public FindActiveRuleByProductVoTupleScheme getScheme() {
      return new FindActiveRuleByProductVoTupleScheme();
    }
  }

  private static class FindActiveRuleByProductVoTupleScheme extends TupleScheme<FindActiveRuleByProductVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FindActiveRuleByProductVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProductIdList()) {
        {
          ...
          for (String _iter220 : struct.productIdList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FindActiveRuleByProductVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.productIdList = new ArrayList<String>(_list221.size);
          String _elem222;
          for (int _i223 = 0; _i223 < _list221.size; ++_i223)
          {
            _elem222 = iprot.readString();
            struct.productIdList.add(_elem222);
          }
        }
        struct.setProductIdListIsSet(true);
      }
