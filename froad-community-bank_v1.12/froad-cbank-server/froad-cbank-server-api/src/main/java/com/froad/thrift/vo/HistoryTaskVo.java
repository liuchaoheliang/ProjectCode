...
public class HistoryTaskVo implements org.apache.thrift.TBase<HistoryTaskVo, HistoryTaskVo._Fields>, java.io.Serializable, Cloneable, Comparable<HistoryTaskVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HistoryTaskVo");
  ...
  private static final org.apache.thrift.protocol.TField TASK_STATE_FIELD_DESC = new org.apache.thrift.protocol.TField("taskState", org.apache.thrift.protocol.TType.STRING, (short)13);
  ...
  private static final org.apache.thrift.protocol.TField AUDIT_STATE_FIELD_DESC = new org.apache.thrift.protocol.TField("auditState", org.apache.thrift.protocol.TType.STRING, (short)16);
  ...
  static {
    schemes.put(StandardScheme.class, new HistoryTaskVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HistoryTaskVoTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * auditState
     */
    AUDIT_STATE((short)16, "auditState"),
    /**
     * remark
     */
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.CLIENT_ID,_Fields.INSTANCE_ID,_Fields.NODE_ID,_Fields.TASK_ID,_Fields.PARENT_TASK_ID,_Fields.NAME,_Fields.DISPLAY_NAME,_Fields.PERFORM_TYPE,_Fields.TASK_TYPE,_Fields.TASK_STATE,_Fields.OPERATOR,_Fields.FINISH_TIME,_Fields.AUDIT_STATE,_Fields.REMARK,_Fields.ORG_CODE};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HistoryTaskVo.class, metaDataMap);
  }
   ...
   */
  public HistoryTaskVo(HistoryTaskVo other) {
  ...
  public HistoryTaskVo deepCopy() {
    return new HistoryTaskVo(this);
  }
   ...
   * id
   */
  public HistoryTaskVo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
   ...
   * createTime
   */
  public HistoryTaskVo setCreateTime(long createTime) {
   ...
   * updateTime
   */
  public HistoryTaskVo setUpdateTime(long updateTime) {
   ...
   * clientId
   */
  public HistoryTaskVo setClientId(String clientId) {
   ...
   * instanceId
   */
  public HistoryTaskVo setInstanceId(String instanceId) {
   ...
   * nodeId
   */
  public HistoryTaskVo setNodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
   ...
   * taskId
   */
  public HistoryTaskVo setTaskId(String taskId) {
    this.taskId = taskId;
    return this;
  }
   ...
   * parentTaskId
   */
  public HistoryTaskVo setParentTaskId(String parentTaskId) {
   ...
   * name
   */
  public HistoryTaskVo setName(String name) {
    this.name = name;
    return this;
  }
   ...
   * displayName
   */
  public HistoryTaskVo setDisplayName(String displayName) {
   ...
   * performType
   */
  public HistoryTaskVo setPerformType(String performType) {
   ...
   * taskType
   */
  public HistoryTaskVo setTaskType(String taskType) {
   ...
   * taskState
   */
  public HistoryTaskVo setTaskState(String taskState) {
   ...
   * operator
   */
  public HistoryTaskVo setOperator(String operator) {
   ...
   * finishTime
   */
  public HistoryTaskVo setFinishTime(long finishTime) {
   ...
   * auditState
   */
  public HistoryTaskVo setAuditState(String auditState) {
   ...
   * remark
   */
  public HistoryTaskVo setRemark(String remark) {
    this.remark = remark;
    return this;
  }
   ...
   * orgCode
   */
  public HistoryTaskVo setOrgCode(String orgCode) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof HistoryTaskVo)
      return this.equals((HistoryTaskVo)that);
    return false;
  }

  public boolean equals(HistoryTaskVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(HistoryTaskVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HistoryTaskVo(");
    boolean first = true;
  ...
  private static class HistoryTaskVoStandardSchemeFactory implements SchemeFactory {
    public HistoryTaskVoStandardScheme getScheme() {
      return new HistoryTaskVoStandardScheme();
    }
  }

  private static class HistoryTaskVoStandardScheme extends StandardScheme<HistoryTaskVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HistoryTaskVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HistoryTaskVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class HistoryTaskVoTupleSchemeFactory implements SchemeFactory {
    public HistoryTaskVoTupleScheme getScheme() {
      return new HistoryTaskVoTupleScheme();
    }
  }

  private static class HistoryTaskVoTupleScheme extends TupleScheme<HistoryTaskVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HistoryTaskVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HistoryTaskVo struct) throws org.apache.thrift.TException {
