...
public class FindAdvertisingResultVo implements org.apache.thrift.TBase<FindAdvertisingResultVo, FindAdvertisingResultVo._Fields>, java.io.Serializable, Cloneable, Comparable<FindAdvertisingResultVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FindAdvertisingResultVo");
  ...
  static {
    schemes.put(StandardScheme.class, new FindAdvertisingResultVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FindAdvertisingResultVoTupleSchemeFactory());
  }
   ...
   * 结果
   */
  public AdvertisingVo advertisingVo; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FindAdvertisingResultVo.class, metaDataMap);
  }

  public FindAdvertisingResultVo() {
  }
   ...
   */
  public FindAdvertisingResultVo(FindAdvertisingResultVo other) {
    if (other.isSetResultVo()) {
      this.resultVo = new com.froad.thrift.vo.ResultVo(other.resultVo);
    }
    if (other.isSetAdvertisingVo()) {
      this.advertisingVo = new AdvertisingVo(other.advertisingVo);
    }
  }

  public FindAdvertisingResultVo deepCopy() {
    return new FindAdvertisingResultVo(this);
  }
   ...
   * ResultVo 结果
   */
  public FindAdvertisingResultVo setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 结果
   */
  public FindAdvertisingResultVo setAdvertisingVo(AdvertisingVo advertisingVo) {
    this.advertisingVo = advertisingVo;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ADVERTISING_VO:
      if (value == null) {
        ...
        setAdvertisingVo((AdvertisingVo)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FindAdvertisingResultVo)
      return this.equals((FindAdvertisingResultVo)that);
    return false;
  }

  public boolean equals(FindAdvertisingResultVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FindAdvertisingResultVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FindAdvertisingResultVo(");
    boolean first = true;
  ...
  private static class FindAdvertisingResultVoStandardSchemeFactory implements SchemeFactory {
    public FindAdvertisingResultVoStandardScheme getScheme() {
      return new FindAdvertisingResultVoStandardScheme();
    }
  }

  private static class FindAdvertisingResultVoStandardScheme extends StandardScheme<FindAdvertisingResultVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FindAdvertisingResultVo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // ADVERTISING_VO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.advertisingVo = new AdvertisingVo();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindAdvertisingResultVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FindAdvertisingResultVoTupleSchemeFactory implements SchemeFactory {
    public FindAdvertisingResultVoTupleScheme getScheme() {
      return new FindAdvertisingResultVoTupleScheme();
    }
  }

  private static class FindAdvertisingResultVoTupleScheme extends TupleScheme<FindAdvertisingResultVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FindAdvertisingResultVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FindAdvertisingResultVo struct) throws org.apache.thrift.TException {
