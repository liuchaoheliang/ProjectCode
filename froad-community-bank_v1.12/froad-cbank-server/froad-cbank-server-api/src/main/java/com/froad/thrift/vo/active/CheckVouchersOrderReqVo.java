...
public class CheckVouchersOrderReqVo implements org.apache.thrift.TBase<CheckVouchersOrderReqVo, CheckVouchersOrderReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<CheckVouchersOrderReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CheckVouchersOrderReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new CheckVouchersOrderReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CheckVouchersOrderReqVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CheckVouchersOrderReqVo.class, metaDataMap);
  }

  public CheckVouchersOrderReqVo() {
  }
   ...
   */
  public CheckVouchersOrderReqVo(CheckVouchersOrderReqVo other) {
  ...
  public CheckVouchersOrderReqVo deepCopy() {
    return new CheckVouchersOrderReqVo(this);
  }
   ...
   * 请求id
   */
  public CheckVouchersOrderReqVo setReqId(String reqId) {
    this.reqId = reqId;
    return this;
  }
   ...
   * 客户端id
   */
  public CheckVouchersOrderReqVo setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
   ...
   * 用户编号
   */
  public CheckVouchersOrderReqVo setMemberCode(long memberCode) {
    this.memberCode = memberCode;
    setMemberCodeIsSet(true);
    return this;
  }
   ...
   * 订单金额
   */
  public CheckVouchersOrderReqVo setOrderMoney(double orderMoney) {
    this.orderMoney = orderMoney;
    setOrderMoneyIsSet(true);
    return this;
  }
   ...
   * 代金券id 列表
   */
  public CheckVouchersOrderReqVo setVouchersIds(List<String> vouchersIds) {
    this.vouchersIds = vouchersIds;
    return this;
  }
   ...
   * 订单中参与的别的营销活动id列表
   */
  public CheckVouchersOrderReqVo setSustainActiveIds(List<String> sustainActiveIds) {
    this.sustainActiveIds = sustainActiveIds;
    return this;
  }
   ...
   * 商品列表 - 查询校验使用
   */
  public CheckVouchersOrderReqVo setProductOfFindUseList(List<ProductOfFindUseVo> productOfFindUseList) {
    this.productOfFindUseList = productOfFindUseList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CheckVouchersOrderReqVo)
      return this.equals((CheckVouchersOrderReqVo)that);
    return false;
  }

  public boolean equals(CheckVouchersOrderReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CheckVouchersOrderReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CheckVouchersOrderReqVo(");
    boolean first = true;
  ...
  private static class CheckVouchersOrderReqVoStandardSchemeFactory implements SchemeFactory {
    public CheckVouchersOrderReqVoStandardScheme getScheme() {
      return new CheckVouchersOrderReqVoStandardScheme();
    }
  }

  private static class CheckVouchersOrderReqVoStandardScheme extends StandardScheme<CheckVouchersOrderReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CheckVouchersOrderReqVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vouchersIds = new ArrayList<String>(_list352.size);
                String _elem353;
                for (int _i354 = 0; _i354 < _list352.size; ++_i354)
                {
                  _elem353 = iprot.readString();
                  struct.vouchersIds.add(_elem353);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sustainActiveIds = new ArrayList<String>(_list355.size);
                String _elem356;
                for (int _i357 = 0; _i357 < _list355.size; ++_i357)
                {
                  _elem356 = iprot.readString();
                  struct.sustainActiveIds.add(_elem356);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productOfFindUseList = new ArrayList<ProductOfFindUseVo>(_list358.size);
                ProductOfFindUseVo _elem359;
                for (int _i360 = 0; _i360 < _list358.size; ++_i360)
                {
                  _elem359 = new ProductOfFindUseVo();
                  _elem359.read(iprot);
                  struct.productOfFindUseList.add(_elem359);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CheckVouchersOrderReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.vouchersIds != null) {
        oprot.writeFieldBegin(VOUCHERS_IDS_FIELD_DESC);
        {
          ...
          for (String _iter361 : struct.vouchersIds)
          {
      ...
      if (struct.sustainActiveIds != null) {
        oprot.writeFieldBegin(SUSTAIN_ACTIVE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter362 : struct.sustainActiveIds)
          {
      ...
      if (struct.productOfFindUseList != null) {
        oprot.writeFieldBegin(PRODUCT_OF_FIND_USE_LIST_FIELD_DESC);
        {
          ...
          for (ProductOfFindUseVo _iter363 : struct.productOfFindUseList)
          {
  ...
  private static class CheckVouchersOrderReqVoTupleSchemeFactory implements SchemeFactory {
    public CheckVouchersOrderReqVoTupleScheme getScheme() {
      return new CheckVouchersOrderReqVoTupleScheme();
    }
  }

  private static class CheckVouchersOrderReqVoTupleScheme extends TupleScheme<CheckVouchersOrderReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CheckVouchersOrderReqVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetVouchersIds()) {
        {
          ...
          for (String _iter364 : struct.vouchersIds)
          {
      ...
      if (struct.isSetSustainActiveIds()) {
        {
          ...
          for (String _iter365 : struct.sustainActiveIds)
          {
      ...
      if (struct.isSetProductOfFindUseList()) {
        {
          ...
          for (ProductOfFindUseVo _iter366 : struct.productOfFindUseList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CheckVouchersOrderReqVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.vouchersIds = new ArrayList<String>(_list367.size);
          String _elem368;
          for (int _i369 = 0; _i369 < _list367.size; ++_i369)
          {
            _elem368 = iprot.readString();
            struct.vouchersIds.add(_elem368);
          }
        }
        struct.setVouchersIdsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list370 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.sustainActiveIds = new ArrayList<String>(_list370.size);
          String _elem371;
          for (int _i372 = 0; _i372 < _list370.size; ++_i372)
          {
            _elem371 = iprot.readString();
            struct.sustainActiveIds.add(_elem371);
          }
        }
        struct.setSustainActiveIdsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.productOfFindUseList = new ArrayList<ProductOfFindUseVo>(_list373.size);
          ProductOfFindUseVo _elem374;
          for (int _i375 = 0; _i375 < _list373.size; ++_i375)
          {
            _elem374 = new ProductOfFindUseVo();
            _elem374.read(iprot);
            struct.productOfFindUseList.add(_elem374);
          }
        }
        struct.setProductOfFindUseListIsSet(true);
      }
