...
public class OrgRoleListVoRes implements org.apache.thrift.TBase<OrgRoleListVoRes, OrgRoleListVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<OrgRoleListVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrgRoleListVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new OrgRoleListVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrgRoleListVoResTupleSchemeFactory());
  }
   ...
   * 组织角色信息集合
   */
  public List<OrgRoleVo> voList; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.VO_LIST, new org.apache.thrift.meta_data.FieldMetaData("voList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, OrgRoleVo.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrgRoleListVoRes.class, metaDataMap);
  }

  public OrgRoleListVoRes() {
  }

  public OrgRoleListVoRes(
    com.froad.thrift.vo.ResultVo resultVo,
    List<OrgRoleVo> voList)
  {
    this();
   ...
   */
  public OrgRoleListVoRes(OrgRoleListVoRes other) {
    if (other.isSetResultVo()) {
      this.resultVo = new com.froad.thrift.vo.ResultVo(other.resultVo);
    }
    if (other.isSetVoList()) {
      List<OrgRoleVo> __this__voList = new ArrayList<OrgRoleVo>(other.voList.size());
      for (OrgRoleVo other_element : other.voList) {
        __this__voList.add(new OrgRoleVo(other_element));
      }
      this.voList = __this__voList;
    }
  }

  public OrgRoleListVoRes deepCopy() {
    return new OrgRoleListVoRes(this);
  }
   ...
   * 返回结果
   */
  public OrgRoleListVoRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
  ...
  public java.util.Iterator<OrgRoleVo> getVoListIterator() {
    return (this.voList == null) ? null : this.voList.iterator();
  }

  public void addToVoList(OrgRoleVo elem) {
    if (this.voList == null) {
      this.voList = new ArrayList<OrgRoleVo>();
    }
   ...
   * 组织角色信息集合
   */
  public List<OrgRoleVo> getVoList() {
    return this.voList;
  }
   ...
   * 组织角色信息集合
   */
  public OrgRoleListVoRes setVoList(List<OrgRoleVo> voList) {
    this.voList = voList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VO_LIST:
      if (value == null) {
        ...
        setVoList((List<OrgRoleVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrgRoleListVoRes)
      return this.equals((OrgRoleListVoRes)that);
    return false;
  }

  public boolean equals(OrgRoleListVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OrgRoleListVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrgRoleListVoRes(");
    boolean first = true;
  ...
  private static class OrgRoleListVoResStandardSchemeFactory implements SchemeFactory {
    public OrgRoleListVoResStandardScheme getScheme() {
      return new OrgRoleListVoResStandardScheme();
    }
  }

  private static class OrgRoleListVoResStandardScheme extends StandardScheme<OrgRoleListVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrgRoleListVoRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.voList = new ArrayList<OrgRoleVo>(_list32.size);
                OrgRoleVo _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new OrgRoleVo();
                  _elem33.read(iprot);
                  struct.voList.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrgRoleListVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.voList != null) {
        oprot.writeFieldBegin(VO_LIST_FIELD_DESC);
        {
          ...
          for (OrgRoleVo _iter35 : struct.voList)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class OrgRoleListVoResTupleSchemeFactory implements SchemeFactory {
    public OrgRoleListVoResTupleScheme getScheme() {
      return new OrgRoleListVoResTupleScheme();
    }
  }

  private static class OrgRoleListVoResTupleScheme extends TupleScheme<OrgRoleListVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrgRoleListVoRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetVoList()) {
        {
          ...
          for (OrgRoleVo _iter36 : struct.voList)
          {
            _iter36.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrgRoleListVoRes struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.voList = new ArrayList<OrgRoleVo>(_list37.size);
          OrgRoleVo _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new OrgRoleVo();
            _elem38.read(iprot);
            struct.voList.add(_elem38);
          }
        }
        struct.setVoListIsSet(true);
      }
