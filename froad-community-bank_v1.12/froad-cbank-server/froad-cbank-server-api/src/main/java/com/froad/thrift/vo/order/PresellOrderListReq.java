...
public class PresellOrderListReq implements org.apache.thrift.TBase<PresellOrderListReq, PresellOrderListReq._Fields>, java.io.Serializable, Cloneable, Comparable<PresellOrderListReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PresellOrderListReq");
  ...
  private static final org.apache.thrift.protocol.TField SETTLEMENT_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("settlementStatus", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new PresellOrderListReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PresellOrderListReqTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 结算状态0:未结算;1:结算中;2:结算成功;3:结算失败;4:无效结算记录
     */
    SETTLEMENT_STATUS((short)4, "settlementStatus"),
    /**
     * 商品名称
     */
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PresellOrderListReq.class, metaDataMap);
  }

  public PresellOrderListReq() {
  }
   ...
   */
  public PresellOrderListReq(PresellOrderListReq other) {
  ...
  public PresellOrderListReq deepCopy() {
    return new PresellOrderListReq(this);
  }
   ...
   * 订单编号
   */
  public PresellOrderListReq setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 手机号
   */
  public PresellOrderListReq setPhone(String phone) {
    this.phone = phone;
    return this;
  }
   ...
   * 券号状态:0:待发送;1:已发送;2:已消费;3:已过期;4:已退款;5:退款中;6:退款失败;7:已过期退款;8:未发码退款;9:已过期退款中
   */
  public PresellOrderListReq setTicketStatus(String ticketStatus) {
    this.ticketStatus = ticketStatus;
    return this;
  }
   ...
   * 结算状态0:未结算;1:结算中;2:结算成功;3:结算失败;4:无效结算记录
   */
  public PresellOrderListReq setSettlementStatus(String settlementStatus) {
    this.settlementStatus = settlementStatus;
    return this;
  }
   ...
   * 商品名称
   */
  public PresellOrderListReq setProductName(String productName) {
    this.productName = productName;
    return this;
  }
   ...
   * 用户名:提货人姓名
   */
  public PresellOrderListReq setMemberName(String memberName) {
    this.memberName = memberName;
    return this;
  }
   ...
   * 开始时间
   */
  public PresellOrderListReq setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
   ...
   * 结束时间
   */
  public PresellOrderListReq setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
   ...
   * 分页
   */
  public PresellOrderListReq setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PresellOrderListReq)
      return this.equals((PresellOrderListReq)that);
    return false;
  }

  public boolean equals(PresellOrderListReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PresellOrderListReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PresellOrderListReq(");
    boolean first = true;
  ...
  private static class PresellOrderListReqStandardSchemeFactory implements SchemeFactory {
    public PresellOrderListReqStandardScheme getScheme() {
      return new PresellOrderListReqStandardScheme();
    }
  }

  private static class PresellOrderListReqStandardScheme extends StandardScheme<PresellOrderListReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PresellOrderListReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PresellOrderListReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PresellOrderListReqTupleSchemeFactory implements SchemeFactory {
    public PresellOrderListReqTupleScheme getScheme() {
      return new PresellOrderListReqTupleScheme();
    }
  }

  private static class PresellOrderListReqTupleScheme extends TupleScheme<PresellOrderListReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PresellOrderListReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PresellOrderListReq struct) throws org.apache.thrift.TException {
