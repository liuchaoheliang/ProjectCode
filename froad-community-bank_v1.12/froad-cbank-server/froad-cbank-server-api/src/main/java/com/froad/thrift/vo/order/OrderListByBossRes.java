...
public class OrderListByBossRes implements org.apache.thrift.TBase<OrderListByBossRes, OrderListByBossRes._Fields>, java.io.Serializable, Cloneable, Comparable<OrderListByBossRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrderListByBossRes");
  ...
  static {
    schemes.put(StandardScheme.class, new OrderListByBossResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrderListByBossResTupleSchemeFactory());
  }

  /**
   * 订单数据
   */
  public List<OrderVo> orders; // required
  /**
   * 查询结果
   */
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrderListByBossRes.class, metaDataMap);
  }

  public OrderListByBossRes() {
  }
   ...
   */
  public OrderListByBossRes(OrderListByBossRes other) {
    if (other.isSetOrders()) {
      List<OrderVo> __this__orders = new ArrayList<OrderVo>(other.orders.size());
      for (OrderVo other_element : other.orders) {
        __this__orders.add(new OrderVo(other_element));
      }
  ...
  public OrderListByBossRes deepCopy() {
    return new OrderListByBossRes(this);
  }
  ...
  public java.util.Iterator<OrderVo> getOrdersIterator() {
    return (this.orders == null) ? null : this.orders.iterator();
  }

  public void addToOrders(OrderVo elem) {
    if (this.orders == null) {
      this.orders = new ArrayList<OrderVo>();
    }
   ...
   * 订单数据
   */
  public OrderListByBossRes setOrders(List<OrderVo> orders) {
    this.orders = orders;
    return this;
  }
   ...
   * 查询结果
   */
  public OrderListByBossRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 分页数据
   */
  public OrderListByBossRes setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrderListByBossRes)
      return this.equals((OrderListByBossRes)that);
    return false;
  }

  public boolean equals(OrderListByBossRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OrderListByBossRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrderListByBossRes(");
    boolean first = true;
  ...
  private static class OrderListByBossResStandardSchemeFactory implements SchemeFactory {
    public OrderListByBossResStandardScheme getScheme() {
      return new OrderListByBossResStandardScheme();
    }
  }

  private static class OrderListByBossResStandardScheme extends StandardScheme<OrderListByBossRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrderListByBossRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orders = new ArrayList<OrderVo>(_list104.size);
                OrderVo _elem105;
                for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                {
                  _elem105 = new OrderVo();
                  _elem105.read(iprot);
                  struct.orders.add(_elem105);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrderListByBossRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.orders != null) {
        oprot.writeFieldBegin(ORDERS_FIELD_DESC);
        {
          ...
          for (OrderVo _iter107 : struct.orders)
          {
  ...
  private static class OrderListByBossResTupleSchemeFactory implements SchemeFactory {
    public OrderListByBossResTupleScheme getScheme() {
      return new OrderListByBossResTupleScheme();
    }
  }

  private static class OrderListByBossResTupleScheme extends TupleScheme<OrderListByBossRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrderListByBossRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOrders()) {
        {
          ...
          for (OrderVo _iter108 : struct.orders)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrderListByBossRes struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list109 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.orders = new ArrayList<OrderVo>(_list109.size);
          OrderVo _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new OrderVo();
            _elem110.read(iprot);
            struct.orders.add(_elem110);
          }
        }
        struct.setOrdersIsSet(true);
      }
