...
public class FindVouchersOfCenterReqVo implements org.apache.thrift.TBase<FindVouchersOfCenterReqVo, FindVouchersOfCenterReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<FindVouchersOfCenterReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FindVouchersOfCenterReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new FindVouchersOfCenterReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FindVouchersOfCenterReqVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FindVouchersOfCenterReqVo.class, metaDataMap);
  }

  public FindVouchersOfCenterReqVo() {
  }
   ...
   */
  public FindVouchersOfCenterReqVo(FindVouchersOfCenterReqVo other) {
  ...
  public FindVouchersOfCenterReqVo deepCopy() {
    return new FindVouchersOfCenterReqVo(this);
  }
   ...
   * 请求id
   */
  public FindVouchersOfCenterReqVo setReqId(String reqId) {
    this.reqId = reqId;
    return this;
  }
   ...
   * 客户端id
   */
  public FindVouchersOfCenterReqVo setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
   ...
   * 用户编号
   */
  public FindVouchersOfCenterReqVo setMemberCode(long memberCode) {
    this.memberCode = memberCode;
    setMemberCodeIsSet(true);
    return this;
  }
   ...
   * 1未过期2已过期3已使用
   */
  public FindVouchersOfCenterReqVo setStatus(String status) {
    this.status = status;
    return this;
  }
   ...
   * 分页参数
   */
  public FindVouchersOfCenterReqVo setPage(com.froad.thrift.vo.PageVo page) {
    this.page = page;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FindVouchersOfCenterReqVo)
      return this.equals((FindVouchersOfCenterReqVo)that);
    return false;
  }

  public boolean equals(FindVouchersOfCenterReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FindVouchersOfCenterReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FindVouchersOfCenterReqVo(");
    boolean first = true;
  ...
  private static class FindVouchersOfCenterReqVoStandardSchemeFactory implements SchemeFactory {
    public FindVouchersOfCenterReqVoStandardScheme getScheme() {
      return new FindVouchersOfCenterReqVoStandardScheme();
    }
  }

  private static class FindVouchersOfCenterReqVoStandardScheme extends StandardScheme<FindVouchersOfCenterReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FindVouchersOfCenterReqVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindVouchersOfCenterReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FindVouchersOfCenterReqVoTupleSchemeFactory implements SchemeFactory {
    public FindVouchersOfCenterReqVoTupleScheme getScheme() {
      return new FindVouchersOfCenterReqVoTupleScheme();
    }
  }

  private static class FindVouchersOfCenterReqVoTupleScheme extends TupleScheme<FindVouchersOfCenterReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FindVouchersOfCenterReqVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FindVouchersOfCenterReqVo struct) throws org.apache.thrift.TException {
