...
public class AddVIPOrderVoRes implements org.apache.thrift.TBase<AddVIPOrderVoRes, AddVIPOrderVoRes._Fields>, java.io.Serializable, Cloneable, Comparable<AddVIPOrderVoRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddVIPOrderVoRes");
  ...
  static {
    schemes.put(StandardScheme.class, new AddVIPOrderVoResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddVIPOrderVoResTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddVIPOrderVoRes.class, metaDataMap);
  }

  public AddVIPOrderVoRes() {
  }
   ...
   */
  public AddVIPOrderVoRes(AddVIPOrderVoRes other) {
  ...
  public AddVIPOrderVoRes deepCopy() {
    return new AddVIPOrderVoRes(this);
  }
   ...
   * 结果信息
   */
  public AddVIPOrderVoRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 订单ID
   */
  public AddVIPOrderVoRes setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 订单总金额
   */
  public AddVIPOrderVoRes setTotalPrice(double totalPrice) {
    this.totalPrice = totalPrice;
    setTotalPriceIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddVIPOrderVoRes)
      return this.equals((AddVIPOrderVoRes)that);
    return false;
  }

  public boolean equals(AddVIPOrderVoRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddVIPOrderVoRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddVIPOrderVoRes(");
    boolean first = true;
  ...
  private static class AddVIPOrderVoResStandardSchemeFactory implements SchemeFactory {
    public AddVIPOrderVoResStandardScheme getScheme() {
      return new AddVIPOrderVoResStandardScheme();
    }
  }

  private static class AddVIPOrderVoResStandardScheme extends StandardScheme<AddVIPOrderVoRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddVIPOrderVoRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddVIPOrderVoRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AddVIPOrderVoResTupleSchemeFactory implements SchemeFactory {
    public AddVIPOrderVoResTupleScheme getScheme() {
      return new AddVIPOrderVoResTupleScheme();
    }
  }

  private static class AddVIPOrderVoResTupleScheme extends TupleScheme<AddVIPOrderVoRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddVIPOrderVoRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddVIPOrderVoRes struct) throws org.apache.thrift.TException {
