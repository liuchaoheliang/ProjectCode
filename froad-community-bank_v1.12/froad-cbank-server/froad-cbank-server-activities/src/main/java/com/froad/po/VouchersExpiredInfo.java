...
/**
 * CbVouchersExpiredInfo entity. 
 */


public class VouchersExpiredInfo implements java.io.Serializable {
	...
	/** default constructor */
	public VouchersExpiredInfo() {
	}

	/** minimal constructor */
	public VouchersExpiredInfo(String clientId, Timestamp createTime, Timestamp updateTime, String activeId, String vouchersId, Integer vouchersMoney, Long vouchersUseMoney, Long vouchersResMoney, String status) {
	...
	/** full constructor */
	public VouchersExpiredInfo(String clientId, Timestamp createTime, Timestamp updateTime, String activeId, String vouchersId, Integer vouchersMoney, Long vouchersUseMoney, Long vouchersResMoney, Long memberCode, String sendActiveId, Timestamp sendTime, String status, Timestamp useTime, Long userMemberCode) {
		this.clientId = clientId;
		this.createTime = createTime;
		this.updateTime = updateTime;
		this.activeId = activeId;
