...
public class SeckillOrderClient {
...
//    public static final int TIMEOUT = 30000;
    ...
    public class Data{
    	...
    	//商品6-网点礼品
    	String productId6 = "007e0d0f0000";
    	...
    	//网点礼品
    	String merchantId5 = "004171df0000";
...
//    	redis.hset(RedisKeyUtil.cbbank_activities_client_id_activities_id(data.clientId,data.activityId2),"vip_price",data.vipPrice);
     ...
     * 订单创建
     */
    public void testSeckillAddOrder(SeckillOrderService.Client client) throws TException{
    	AddSeckillOrderVoReq request = new AddSeckillOrderVoReq();
        request.setClientId(data.clientId);
        request.setMemberCode(50000000225L);
        request.setMemberName(data.memberName);
        request.setCreateSource(CreateSource.android.getCode());
        request.setReqId(data.phone);
        request.setMerchantId("01B61F4C8000");
        request.setRemark("秒杀测试");
        request.setProductId("01B682E18000");
        request.setProductName("测试商户BBB");
        request.setProductImage("/froad-cbank/image/201501/83648df1-6f7c-480b-8456-147febf38edb-thumbnail.jpg");
        request.setProductType(ProductType.special.getCode());
        request.setDeliveryMoney(1);
        request.setMoney(0.1);
        request.setQuantity(2);
        request.setVipMoney(0);
        request.setVipQuantity(0);
        request.setRemark("线下积分兑换-创建订单测试");
        AddSeckillOrderVoRes response = client.addOrder(request);
...
//            TProtocol protocol = new TBinaryProtocol(transport);
            ...
            SeckillOrderService.Client client = new SeckillOrderService.Client(protocol);
            transport.open();
...
//            testGetPointExchangeDetail(client);
    ...
    public static void main(String[] args) {
        SeckillOrderClient client = new SeckillOrderClient();
        client.startClient();
