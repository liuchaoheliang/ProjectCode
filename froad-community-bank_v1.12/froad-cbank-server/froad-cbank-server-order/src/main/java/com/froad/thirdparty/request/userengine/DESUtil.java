...
public final class DESUtil {
	...
	private static final String PASSWORD_CRYPT_KEY = "__PAY__DES__KINGO__UAA4__GMMH__WIDG__MUXk__EADC__BiQK__BBQD";
	...
	public static void main(String[] args){
		String a=encrypt("111111");
		System.out.println(a+",leng:"+a.length());
		System.out.println(decrypt("890b56dffbaa3895998ed6771aeb4dfa4691d6d93f0763f1"));
	}
}
