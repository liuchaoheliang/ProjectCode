...
public class OutletRedis {
	...
	public OutletRedis(RedisManager redis){
		redisManager = redis;
	}
	
	
	public  boolean set_cbbank_merchant_outlet_client_id_merchant_id(OutletCG... outlets) {
	...
	public  boolean del_cbbank_merchant_outlet_client_id_merchant_id(OutletCG... outlets) {
		int i = 0;
...
//		return i > -1;
	 ...
	 * @throws
	 */
	public  boolean set_cbbank_outlet_client_id_merchant_id_outlet_id(OutletCG outlet) {
		...
		boolean b = set_cbbank_outlet_client_id_merchant_id_outlet_id(outlet.getClientId(), outlet.getMerchantId(), outlet.getOutletId(), hash);
		return b;
	}
	
	public  boolean set_cbbank_outlet_client_id_merchant_id_outlet_id(String client_id, String merchant_id, String oulet_id, Map<String, String> hash) {
	...
	public  boolean set_cbbank_outlet_client_id_merchant_id_outlet_id(String client_id, String merchant_id, String oulet_id, String field, String value) {
		String key = RedisKeyUtil.cbbank_outlet_client_id_merchant_id_outlet_id(client_id, merchant_id, oulet_id);
	...
	public  boolean del_cbbank_outlet_client_id_merchant_id_outlet_id(OutletCG... outlets) {
		for (OutletCG outlet : outlets) {
	...
	public  Map<String,String> get_cbbank_outlet_client_id_merchant_id_outlet_id(String client_id,String merchant_id,String oulet_id) {
		String key = RedisKeyUtil.cbbank_outlet_client_id_merchant_id_outlet_id(client_id, merchant_id, oulet_id);
