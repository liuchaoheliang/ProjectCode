 ...
 *
 */
public class ProductPresellCG implements java.io.Serializable {
	...
	/** default constructor */
	public ProductPresellCG() {
	}

	/** minimal constructor */
	public ProductPresellCG(Date createTime, String clientId, Date deliveryStartTime, Date deliveryEndTime, Boolean clusterState, Boolean clusterType, Date expireStartTime, Date expireEndTime) {
