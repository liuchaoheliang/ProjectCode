...
public class BankOrgCode {
	...
	public String getCountryAgency() {
		return countryAgency;
	}
	
	public void setCountryAgency(String countryAgency) {
		this.countryAgency = countryAgency;
	}
