 ...
 * 地区表
 */
public class AreaCG implements java.io.Serializable {
	...
	/** minimal constructor */
	public AreaCG(String name, String treePath) {
		this.name = name;
		this.treePath = treePath;
	}

	/** full constructor */
	public AreaCG(String name, String vagueLetter, String treePath, Long parentId) {
		this.name = name;
