 ...
 * 
 */
public class ProductPresell extends BaseEntity {
...
//	private String price;// 销售价
    ...
    private String presellDetails;//预售详情(HTML5)
    private String purchaseNotes;//购买须知(HTML5)
...
//	}
	...
	public String getPresellDetails() {
		return presellDetails;
	}
	public void setPresellDetails(String presellDetails) {
		this.presellDetails = presellDetails;
	}
