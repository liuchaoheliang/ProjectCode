 ...
 * CbAdPosition entity. 
 */
public class AdPositionCG implements java.io.Serializable {
	...
	/** minimal constructor */
	public AdPositionCG(String clientId, String name, Integer width, Integer height, String positionPage, Integer positionPoint, Boolean isEnable) {
	...
	/** full constructor */
	public AdPositionCG(String clientId, String name, Integer width, Integer height, String positionStyle, String positionPage, Integer positionPoint, String description, Boolean isEnable) {
		this.clientId = clientId;
		this.name = name;
		this.width = width;
		this.height = height;
