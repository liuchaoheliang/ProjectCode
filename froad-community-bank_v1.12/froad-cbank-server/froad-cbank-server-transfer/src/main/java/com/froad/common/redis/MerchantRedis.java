...
//	}
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_merchant_client_id_merchant_id(Merchant... merchants){
...
//			hash.put("is_enable", ObjectUtils.toString(merchant.getIsEnable(), ""));
			hash.put("area_id", ObjectUtils.toString(merchant.getAreaId(), ""));
...
//			String result = RedisManager.getJedis().hmset(key, hash);
	...
	public static boolean set_cbbank_merchant_client_id_merchant_id(String client_id, String merchant_id, Map<String, String> hash) {
		String key = RedisKeyUtil.cbbank_merchant_client_id_merchant_id(client_id, merchant_id);
...
//			hash.put("is_enable", ObjectUtils.toString(merchant.getIsEnable(), ""));
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_area_merchant_client_id_area_id(Merchant... merchants){
		for (Merchant merchant : merchants) {
	 ...
	 * @throws
	 */
	public static boolean set_cbbank_area_merchant_client_id_area_id(String client_id, Long area_id, String merchant_id)  {
		String key = RedisKeyUtil.cbbank_area_merchant_client_id_area_id( client_id, area_id);
		Long result = redisManager.put(key, ObjectUtils.toString(merchant_id, ""));
		LogCvt.info("设置缓存:" + result + "成功!");
//		LogCvt.info("设置缓存:" + key + "成功! type-->" + redisManager.getType(key));
		return result > -1;
	}
