...
//import com.froad.db.chonggou.entity.RecommentNotEmpty;
//import com.froad.db.chonggou.entity.StarLevelFilter;
...
//		page.setPageCount(mPage.getTotalPage());
//		page.setTotalCount(mPage.getTotalNumber());
//		
//		return page;
//	}
//	
...
//		OrgLevelEnum orgLevelEnum = orgCommonLogic.getOrgLevelByOrgCode(orgCode, clientId);
