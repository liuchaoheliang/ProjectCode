...
public class OutletPositionModelRedis {
	...
	// 只适合北纬   东经
	public static boolean setCache(OutletCG... outlets) throws Exception{
...
//		setCache(DISTANCE_MODEL_1000, outlets); // 每隔1000 米建模
	 ...
	 * @throws
	 */
	private static boolean setCache(double distance, OutletCG... outlets)throws Exception{
...
//				Long result = jedis.sadd(key, ObjectUtils.toString(outlet_id, ""));
	...
	public static boolean delCache(OutletCG... outlets) throws Exception{
...
//		delCache(DISTANCE_MODEL_1000, outlets); // 每隔1000 米建模
	...
	public static boolean delCache(double distance, OutletCG... outlets)throws Exception{
