...
public class ProductWeightActivityTagPageReqVo implements org.apache.thrift.TBase<ProductWeightActivityTagPageReqVo, ProductWeightActivityTagPageReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<ProductWeightActivityTagPageReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProductWeightActivityTagPageReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new ProductWeightActivityTagPageReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProductWeightActivityTagPageReqVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProductWeightActivityTagPageReqVo.class, metaDataMap);
  }

  public ProductWeightActivityTagPageReqVo() {
  }
   ...
   */
  public ProductWeightActivityTagPageReqVo(ProductWeightActivityTagPageReqVo other) {
  ...
  public ProductWeightActivityTagPageReqVo deepCopy() {
    return new ProductWeightActivityTagPageReqVo(this);
  }
   ...
   * 活动标签id *
   */
  public ProductWeightActivityTagPageReqVo setActivityId(long activityId) {
   ...
   * 客户端ID *
   */
  public ProductWeightActivityTagPageReqVo setClientId(String clientId) {
   ...
   * 活动编号 *
   */
  public ProductWeightActivityTagPageReqVo setActivityNo(String activityNo) {
   ...
   * 分页 *
   */
  public ProductWeightActivityTagPageReqVo setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProductWeightActivityTagPageReqVo)
      return this.equals((ProductWeightActivityTagPageReqVo)that);
    return false;
  }

  public boolean equals(ProductWeightActivityTagPageReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProductWeightActivityTagPageReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProductWeightActivityTagPageReqVo(");
    boolean first = true;
  ...
  private static class ProductWeightActivityTagPageReqVoStandardSchemeFactory implements SchemeFactory {
    public ProductWeightActivityTagPageReqVoStandardScheme getScheme() {
      return new ProductWeightActivityTagPageReqVoStandardScheme();
    }
  }

  private static class ProductWeightActivityTagPageReqVoStandardScheme extends StandardScheme<ProductWeightActivityTagPageReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProductWeightActivityTagPageReqVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductWeightActivityTagPageReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ProductWeightActivityTagPageReqVoTupleSchemeFactory implements SchemeFactory {
    public ProductWeightActivityTagPageReqVoTupleScheme getScheme() {
      return new ProductWeightActivityTagPageReqVoTupleScheme();
    }
  }

  private static class ProductWeightActivityTagPageReqVoTupleScheme extends TupleScheme<ProductWeightActivityTagPageReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProductWeightActivityTagPageReqVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProductWeightActivityTagPageReqVo struct) throws org.apache.thrift.TException {
