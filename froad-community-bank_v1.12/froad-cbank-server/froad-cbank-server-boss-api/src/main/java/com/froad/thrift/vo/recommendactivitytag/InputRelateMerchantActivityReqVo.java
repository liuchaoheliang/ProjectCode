...
public class InputRelateMerchantActivityReqVo implements org.apache.thrift.TBase<InputRelateMerchantActivityReqVo, InputRelateMerchantActivityReqVo._Fields>, java.io.Serializable, Cloneable, Comparable<InputRelateMerchantActivityReqVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InputRelateMerchantActivityReqVo");
  ...
  static {
    schemes.put(StandardScheme.class, new InputRelateMerchantActivityReqVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InputRelateMerchantActivityReqVoTupleSchemeFactory());
  }

  /**
   * 导入文件数据 *
   */
  public List<InputRelateMerchantActivityVo> vos; // optional
  /**
   * 活动标签id *
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.VOS, new org.apache.thrift.meta_data.FieldMetaData("vos", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, InputRelateMerchantActivityVo.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InputRelateMerchantActivityReqVo.class, metaDataMap);
  }

  public InputRelateMerchantActivityReqVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public InputRelateMerchantActivityReqVo(InputRelateMerchantActivityReqVo other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetVos()) {
      List<InputRelateMerchantActivityVo> __this__vos = new ArrayList<InputRelateMerchantActivityVo>(other.vos.size());
      for (InputRelateMerchantActivityVo other_element : other.vos) {
        __this__vos.add(new InputRelateMerchantActivityVo(other_element));
      }
  ...
  public InputRelateMerchantActivityReqVo deepCopy() {
    return new InputRelateMerchantActivityReqVo(this);
  }
  ...
  public java.util.Iterator<InputRelateMerchantActivityVo> getVosIterator() {
    return (this.vos == null) ? null : this.vos.iterator();
  }

  public void addToVos(InputRelateMerchantActivityVo elem) {
    if (this.vos == null) {
      this.vos = new ArrayList<InputRelateMerchantActivityVo>();
    }
    this.vos.add(elem);
  }
   ...
   * 导入文件数据 *
   */
  public List<InputRelateMerchantActivityVo> getVos() {
    return this.vos;
  }
   ...
   * 导入文件数据 *
   */
  public InputRelateMerchantActivityReqVo setVos(List<InputRelateMerchantActivityVo> vos) {
    this.vos = vos;
    return this;
  }
   ...
   * 活动标签id *
   */
  public InputRelateMerchantActivityReqVo setActivityId(long activityId) {
   ...
   * 活动编号 *
   */
  public InputRelateMerchantActivityReqVo setActivityNo(String activityNo) {
   ...
   * 客户端号 *
   */
  public InputRelateMerchantActivityReqVo setClientId(String clientId) {
   ...
   * 当前操作员 *
   */
  public InputRelateMerchantActivityReqVo setOperator(String operator) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VOS:
      if (value == null) {
        ...
        setVos((List<InputRelateMerchantActivityVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InputRelateMerchantActivityReqVo)
      return this.equals((InputRelateMerchantActivityReqVo)that);
    return false;
  }

  public boolean equals(InputRelateMerchantActivityReqVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(InputRelateMerchantActivityReqVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InputRelateMerchantActivityReqVo(");
    boolean first = true;
  ...
  private static class InputRelateMerchantActivityReqVoStandardSchemeFactory implements SchemeFactory {
    public InputRelateMerchantActivityReqVoStandardScheme getScheme() {
      return new InputRelateMerchantActivityReqVoStandardScheme();
    }
  }

  private static class InputRelateMerchantActivityReqVoStandardScheme extends StandardScheme<InputRelateMerchantActivityReqVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InputRelateMerchantActivityReqVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vos = new ArrayList<InputRelateMerchantActivityVo>(_list16.size);
                InputRelateMerchantActivityVo _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new InputRelateMerchantActivityVo();
                  _elem17.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InputRelateMerchantActivityReqVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.vos != null) {
        if (struct.isSetVos()) {
          oprot.writeFieldBegin(VOS_FIELD_DESC);
          {
            ...
            for (InputRelateMerchantActivityVo _iter19 : struct.vos)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class InputRelateMerchantActivityReqVoTupleSchemeFactory implements SchemeFactory {
    public InputRelateMerchantActivityReqVoTupleScheme getScheme() {
      return new InputRelateMerchantActivityReqVoTupleScheme();
    }
  }

  private static class InputRelateMerchantActivityReqVoTupleScheme extends TupleScheme<InputRelateMerchantActivityReqVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InputRelateMerchantActivityReqVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetVos()) {
        {
          ...
          for (InputRelateMerchantActivityVo _iter20 : struct.vos)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InputRelateMerchantActivityReqVo struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(5);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list21 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.vos = new ArrayList<InputRelateMerchantActivityVo>(_list21.size);
          InputRelateMerchantActivityVo _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new InputRelateMerchantActivityVo();
            _elem22.read(iprot);
