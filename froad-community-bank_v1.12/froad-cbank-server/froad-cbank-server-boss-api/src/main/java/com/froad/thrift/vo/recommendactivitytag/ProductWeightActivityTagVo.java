...
public class ProductWeightActivityTagVo implements org.apache.thrift.TBase<ProductWeightActivityTagVo, ProductWeightActivityTagVo._Fields>, java.io.Serializable, Cloneable, Comparable<ProductWeightActivityTagVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProductWeightActivityTagVo");
  ...
  private static final org.apache.thrift.protocol.TField MERCHANT_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("merchantName", org.apache.thrift.protocol.TType.STRING, (short)12);
  ...
  static {
    schemes.put(StandardScheme.class, new ProductWeightActivityTagVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProductWeightActivityTagVoTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 所属商户名称 *
     */
    MERCHANT_NAME((short)12, "merchantName"),
    /**
     * 操作人 *
     */
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CLIENT_ID,_Fields.ACTIVITY_ID,_Fields.ACTIVITY_NO,_Fields.ELEMENT_ID,_Fields.WEIGHT,_Fields.ACTIVITY_TYPE,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.PRODUCT_NAME,_Fields.MERCHANT_ID,_Fields.MERCHANT_NAME,_Fields.OPERATOR};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProductWeightActivityTagVo.class, metaDataMap);
  }

  public ProductWeightActivityTagVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ProductWeightActivityTagVo(ProductWeightActivityTagVo other) {
  ...
  public ProductWeightActivityTagVo deepCopy() {
    return new ProductWeightActivityTagVo(this);
  }
   ...
   * id *
   */
  public ProductWeightActivityTagVo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
   ...
   * 客户端ID *
   */
  public ProductWeightActivityTagVo setClientId(String clientId) {
   ...
   * 活动id *
   */
  public ProductWeightActivityTagVo setActivityId(long activityId) {
   ...
   * 活动编号 *
   */
  public ProductWeightActivityTagVo setActivityNo(String activityNo) {
   ...
   * 商户ID/门店ID/商品ID *
   */
  public ProductWeightActivityTagVo setElementId(String elementId) {
   ...
   * 权重 *
   */
  public ProductWeightActivityTagVo setWeight(String weight) {
    this.weight = weight;
    return this;
  }
   ...
   * 活动类型: 商户活动1; 门店活动2; 商品活动3 *
   */
  public ProductWeightActivityTagVo setActivityType(String activityType) {
   ...
   * 创建时间 *
   */
  public ProductWeightActivityTagVo setCreateTime(long createTime) {
   ...
   * 更新时间 *
   */
  public ProductWeightActivityTagVo setUpdateTime(long updateTime) {
   ...
   * 商品名称 *
   */
  public ProductWeightActivityTagVo setProductName(String productName) {
   ...
   * 所属商户Id *
   */
  public ProductWeightActivityTagVo setMerchantId(String merchantId) {
   ...
   * 所属商户名称 *
   */
  public ProductWeightActivityTagVo setMerchantName(String merchantName) {
   ...
   * 操作人 *
   */
  public ProductWeightActivityTagVo setOperator(String operator) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProductWeightActivityTagVo)
      return this.equals((ProductWeightActivityTagVo)that);
    return false;
  }

  public boolean equals(ProductWeightActivityTagVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProductWeightActivityTagVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProductWeightActivityTagVo(");
    boolean first = true;
  ...
  private static class ProductWeightActivityTagVoStandardSchemeFactory implements SchemeFactory {
    public ProductWeightActivityTagVoStandardScheme getScheme() {
      return new ProductWeightActivityTagVoStandardScheme();
    }
  }

  private static class ProductWeightActivityTagVoStandardScheme extends StandardScheme<ProductWeightActivityTagVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProductWeightActivityTagVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductWeightActivityTagVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ProductWeightActivityTagVoTupleSchemeFactory implements SchemeFactory {
    public ProductWeightActivityTagVoTupleScheme getScheme() {
      return new ProductWeightActivityTagVoTupleScheme();
    }
  }

  private static class ProductWeightActivityTagVoTupleScheme extends TupleScheme<ProductWeightActivityTagVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProductWeightActivityTagVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProductWeightActivityTagVo struct) throws org.apache.thrift.TException {
