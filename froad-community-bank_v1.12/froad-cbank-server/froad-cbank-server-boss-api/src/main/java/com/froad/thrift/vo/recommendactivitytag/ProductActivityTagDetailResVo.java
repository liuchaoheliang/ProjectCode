...
public class ProductActivityTagDetailResVo implements org.apache.thrift.TBase<ProductActivityTagDetailResVo, ProductActivityTagDetailResVo._Fields>, java.io.Serializable, Cloneable, Comparable<ProductActivityTagDetailResVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProductActivityTagDetailResVo");
  ...
  static {
    schemes.put(StandardScheme.class, new ProductActivityTagDetailResVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProductActivityTagDetailResVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProductActivityTagDetailResVo.class, metaDataMap);
  }

  public ProductActivityTagDetailResVo() {
  }
   ...
   */
  public ProductActivityTagDetailResVo(ProductActivityTagDetailResVo other) {
  ...
  public ProductActivityTagDetailResVo deepCopy() {
    return new ProductActivityTagDetailResVo(this);
  }
   ...
   * 返回描述 *
   */
  public ProductActivityTagDetailResVo setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 推荐活动信息 *
   */
  public ProductActivityTagDetailResVo setRecommendVo(RecommendActivityTagVo recommendVo) {
    this.recommendVo = recommendVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProductActivityTagDetailResVo)
      return this.equals((ProductActivityTagDetailResVo)that);
    return false;
  }

  public boolean equals(ProductActivityTagDetailResVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProductActivityTagDetailResVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProductActivityTagDetailResVo(");
    boolean first = true;
  ...
  private static class ProductActivityTagDetailResVoStandardSchemeFactory implements SchemeFactory {
    public ProductActivityTagDetailResVoStandardScheme getScheme() {
      return new ProductActivityTagDetailResVoStandardScheme();
    }
  }

  private static class ProductActivityTagDetailResVoStandardScheme extends StandardScheme<ProductActivityTagDetailResVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProductActivityTagDetailResVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductActivityTagDetailResVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ProductActivityTagDetailResVoTupleSchemeFactory implements SchemeFactory {
    public ProductActivityTagDetailResVoTupleScheme getScheme() {
      return new ProductActivityTagDetailResVoTupleScheme();
    }
  }

  private static class ProductActivityTagDetailResVoTupleScheme extends TupleScheme<ProductActivityTagDetailResVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProductActivityTagDetailResVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProductActivityTagDetailResVo struct) throws org.apache.thrift.TException {
