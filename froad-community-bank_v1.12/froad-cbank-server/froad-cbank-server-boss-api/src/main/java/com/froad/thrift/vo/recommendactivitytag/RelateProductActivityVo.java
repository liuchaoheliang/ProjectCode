...
public class RelateProductActivityVo implements org.apache.thrift.TBase<RelateProductActivityVo, RelateProductActivityVo._Fields>, java.io.Serializable, Cloneable, Comparable<RelateProductActivityVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RelateProductActivityVo");
  ...
  static {
    schemes.put(StandardScheme.class, new RelateProductActivityVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RelateProductActivityVoTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.PRODUCT_ID,_Fields.WEIGHT,_Fields.ACTIVITY_ID,_Fields.ACTIVITY_NO,_Fields.CLIENT_ID,_Fields.OPERATOR};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RelateProductActivityVo.class, metaDataMap);
  }

  public RelateProductActivityVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public RelateProductActivityVo(RelateProductActivityVo other) {
  ...
  public RelateProductActivityVo deepCopy() {
    return new RelateProductActivityVo(this);
  }
   ...
   * 商品id *
   */
  public RelateProductActivityVo setProductId(String productId) {
   ...
   * 权重 *
   */
  public RelateProductActivityVo setWeight(String weight) {
    this.weight = weight;
    return this;
  }
   ...
   * 活动标签id *
   */
  public RelateProductActivityVo setActivityId(long activityId) {
   ...
   * 活动编号 *
   */
  public RelateProductActivityVo setActivityNo(String activityNo) {
   ...
   * 客户端号 *
   */
  public RelateProductActivityVo setClientId(String clientId) {
   ...
   * 当前操作员 *
   */
  public RelateProductActivityVo setOperator(String operator) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RelateProductActivityVo)
      return this.equals((RelateProductActivityVo)that);
    return false;
  }

  public boolean equals(RelateProductActivityVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RelateProductActivityVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RelateProductActivityVo(");
    boolean first = true;
  ...
  private static class RelateProductActivityVoStandardSchemeFactory implements SchemeFactory {
    public RelateProductActivityVoStandardScheme getScheme() {
      return new RelateProductActivityVoStandardScheme();
    }
  }

  private static class RelateProductActivityVoStandardScheme extends StandardScheme<RelateProductActivityVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RelateProductActivityVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RelateProductActivityVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RelateProductActivityVoTupleSchemeFactory implements SchemeFactory {
    public RelateProductActivityVoTupleScheme getScheme() {
      return new RelateProductActivityVoTupleScheme();
    }
  }

  private static class RelateProductActivityVoTupleScheme extends TupleScheme<RelateProductActivityVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RelateProductActivityVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RelateProductActivityVo struct) throws org.apache.thrift.TException {
