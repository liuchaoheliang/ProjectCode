            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tickets = new ArrayList<String>(_list16.size);
                String _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = iprot.readString();
                  struct.tickets.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossSettlementVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.tickets != null) {
        oprot.writeFieldBegin(TICKETS_FIELD_DESC);
        {
          ...
          for (String _iter19 : struct.tickets)
          {
      ...
      if (struct.isSetTickets()) {
        {
          ...
          for (String _iter20 : struct.tickets)
          {
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.tickets = new ArrayList<String>(_list21.size);
          String _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = iprot.readString();
            struct.tickets.add(_elem22);
          }
        }
        struct.setTicketsIsSet(true);
      }
