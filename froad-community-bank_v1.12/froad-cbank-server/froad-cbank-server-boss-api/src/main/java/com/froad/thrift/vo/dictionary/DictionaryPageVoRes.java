            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dictionaryVoList = new ArrayList<DictionaryVo>(_list0.size);
                DictionaryVo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new DictionaryVo();
                  _elem1.read(iprot);
                  struct.dictionaryVoList.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DictionaryPageVoRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.dictionaryVoList != null) {
        oprot.writeFieldBegin(DICTIONARY_VO_LIST_FIELD_DESC);
        {
          ...
          for (DictionaryVo _iter3 : struct.dictionaryVoList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetDictionaryVoList()) {
        {
          ...
          for (DictionaryVo _iter4 : struct.dictionaryVoList)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.dictionaryVoList = new ArrayList<DictionaryVo>(_list5.size);
          DictionaryVo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new DictionaryVo();
            _elem6.read(iprot);
            struct.dictionaryVoList.add(_elem6);
          }
        }
        struct.setDictionaryVoListIsSet(true);
      }
