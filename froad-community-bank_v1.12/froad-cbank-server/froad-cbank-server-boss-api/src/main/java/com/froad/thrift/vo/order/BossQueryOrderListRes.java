...
public class BossQueryOrderListRes implements org.apache.thrift.TBase<BossQueryOrderListRes, BossQueryOrderListRes._Fields>, java.io.Serializable, Cloneable, Comparable<BossQueryOrderListRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BossQueryOrderListRes");
  ...
  static {
    schemes.put(StandardScheme.class, new BossQueryOrderListResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BossQueryOrderListResTupleSchemeFactory());
  }

  /**
   * 订单数据
   */
  public List<BossQueryOrderVo> orders; // required
  /**
   * 查询结果
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.ORDERS, new org.apache.thrift.meta_data.FieldMetaData("orders", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "BossQueryOrderVo"))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BossQueryOrderListRes.class, metaDataMap);
  }

  public BossQueryOrderListRes() {
  }

  public BossQueryOrderListRes(
    List<BossQueryOrderVo> orders,
   ...
   */
  public BossQueryOrderListRes(BossQueryOrderListRes other) {
    if (other.isSetOrders()) {
      List<BossQueryOrderVo> __this__orders = new ArrayList<BossQueryOrderVo>(other.orders.size());
      for (BossQueryOrderVo other_element : other.orders) {
  ...
  public BossQueryOrderListRes deepCopy() {
    return new BossQueryOrderListRes(this);
  }
  ...
  public java.util.Iterator<BossQueryOrderVo> getOrdersIterator() {
    return (this.orders == null) ? null : this.orders.iterator();
  }

  public void addToOrders(BossQueryOrderVo elem) {
    if (this.orders == null) {
      this.orders = new ArrayList<BossQueryOrderVo>();
    }
   ...
   * 订单数据
   */
  public List<BossQueryOrderVo> getOrders() {
    return this.orders;
  }
   ...
   * 订单数据
   */
  public BossQueryOrderListRes setOrders(List<BossQueryOrderVo> orders) {
    this.orders = orders;
    return this;
  }
   ...
   * 查询结果
   */
  public BossQueryOrderListRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 分页数据
   */
  public BossQueryOrderListRes setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ORDERS:
      if (value == null) {
        ...
        setOrders((List<BossQueryOrderVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BossQueryOrderListRes)
      return this.equals((BossQueryOrderListRes)that);
    return false;
  }

  public boolean equals(BossQueryOrderListRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BossQueryOrderListRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BossQueryOrderListRes(");
    boolean first = true;
  ...
  private static class BossQueryOrderListResStandardSchemeFactory implements SchemeFactory {
    public BossQueryOrderListResStandardScheme getScheme() {
      return new BossQueryOrderListResStandardScheme();
    }
  }

  private static class BossQueryOrderListResStandardScheme extends StandardScheme<BossQueryOrderListRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BossQueryOrderListRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orders = new ArrayList<BossQueryOrderVo>(_list32.size);
                BossQueryOrderVo _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new BossQueryOrderVo();
                  _elem33.read(iprot);
                  struct.orders.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossQueryOrderListRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.orders != null) {
        oprot.writeFieldBegin(ORDERS_FIELD_DESC);
        {
          ...
          for (BossQueryOrderVo _iter35 : struct.orders)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class BossQueryOrderListResTupleSchemeFactory implements SchemeFactory {
    public BossQueryOrderListResTupleScheme getScheme() {
      return new BossQueryOrderListResTupleScheme();
    }
  }

  private static class BossQueryOrderListResTupleScheme extends TupleScheme<BossQueryOrderListRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BossQueryOrderListRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOrders()) {
        {
          ...
          for (BossQueryOrderVo _iter36 : struct.orders)
          {
            _iter36.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BossQueryOrderListRes struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list37 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.orders = new ArrayList<BossQueryOrderVo>(_list37.size);
          BossQueryOrderVo _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new BossQueryOrderVo();
            _elem38.read(iprot);
            struct.orders.add(_elem38);
          }
        }
        struct.setOrdersIsSet(true);
      }
