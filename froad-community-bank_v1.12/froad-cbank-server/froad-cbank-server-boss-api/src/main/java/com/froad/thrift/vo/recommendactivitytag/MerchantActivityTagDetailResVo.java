...
public class MerchantActivityTagDetailResVo implements org.apache.thrift.TBase<MerchantActivityTagDetailResVo, MerchantActivityTagDetailResVo._Fields>, java.io.Serializable, Cloneable, Comparable<MerchantActivityTagDetailResVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MerchantActivityTagDetailResVo");
  ...
  static {
    schemes.put(StandardScheme.class, new MerchantActivityTagDetailResVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MerchantActivityTagDetailResVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MerchantActivityTagDetailResVo.class, metaDataMap);
  }

  public MerchantActivityTagDetailResVo() {
  }
   ...
   */
  public MerchantActivityTagDetailResVo(MerchantActivityTagDetailResVo other) {
  ...
  public MerchantActivityTagDetailResVo deepCopy() {
    return new MerchantActivityTagDetailResVo(this);
  }
   ...
   * 返回描述 *
   */
  public MerchantActivityTagDetailResVo setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 推荐活动信息 *
   */
  public MerchantActivityTagDetailResVo setRecommendVo(RecommendActivityTagVo recommendVo) {
    this.recommendVo = recommendVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MerchantActivityTagDetailResVo)
      return this.equals((MerchantActivityTagDetailResVo)that);
    return false;
  }

  public boolean equals(MerchantActivityTagDetailResVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MerchantActivityTagDetailResVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MerchantActivityTagDetailResVo(");
    boolean first = true;
  ...
  private static class MerchantActivityTagDetailResVoStandardSchemeFactory implements SchemeFactory {
    public MerchantActivityTagDetailResVoStandardScheme getScheme() {
      return new MerchantActivityTagDetailResVoStandardScheme();
    }
  }

  private static class MerchantActivityTagDetailResVoStandardScheme extends StandardScheme<MerchantActivityTagDetailResVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MerchantActivityTagDetailResVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MerchantActivityTagDetailResVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MerchantActivityTagDetailResVoTupleSchemeFactory implements SchemeFactory {
    public MerchantActivityTagDetailResVoTupleScheme getScheme() {
      return new MerchantActivityTagDetailResVoTupleScheme();
    }
  }

  private static class MerchantActivityTagDetailResVoTupleScheme extends TupleScheme<MerchantActivityTagDetailResVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MerchantActivityTagDetailResVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MerchantActivityTagDetailResVo struct) throws org.apache.thrift.TException {
