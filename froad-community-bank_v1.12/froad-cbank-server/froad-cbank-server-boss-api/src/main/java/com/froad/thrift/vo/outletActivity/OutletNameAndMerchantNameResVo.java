...
public class OutletNameAndMerchantNameResVo implements org.apache.thrift.TBase<OutletNameAndMerchantNameResVo, OutletNameAndMerchantNameResVo._Fields>, java.io.Serializable, Cloneable, Comparable<OutletNameAndMerchantNameResVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OutletNameAndMerchantNameResVo");
  ...
  static {
    schemes.put(StandardScheme.class, new OutletNameAndMerchantNameResVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OutletNameAndMerchantNameResVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OutletNameAndMerchantNameResVo.class, metaDataMap);
  }

  public OutletNameAndMerchantNameResVo() {
  }
   ...
   */
  public OutletNameAndMerchantNameResVo(OutletNameAndMerchantNameResVo other) {
  ...
  public OutletNameAndMerchantNameResVo deepCopy() {
    return new OutletNameAndMerchantNameResVo(this);
  }
   ...
   * 返回描述 *
   */
  public OutletNameAndMerchantNameResVo setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 门店名称 *
   */
  public OutletNameAndMerchantNameResVo setOutletName(String outletName) {
    this.outletName = outletName;
    return this;
  }
   ...
   * 商户名称 *
   */
  public OutletNameAndMerchantNameResVo setMerchantName(String merchantName) {
    this.merchantName = merchantName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OutletNameAndMerchantNameResVo)
      return this.equals((OutletNameAndMerchantNameResVo)that);
    return false;
  }

  public boolean equals(OutletNameAndMerchantNameResVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OutletNameAndMerchantNameResVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OutletNameAndMerchantNameResVo(");
    boolean first = true;
  ...
  private static class OutletNameAndMerchantNameResVoStandardSchemeFactory implements SchemeFactory {
    public OutletNameAndMerchantNameResVoStandardScheme getScheme() {
      return new OutletNameAndMerchantNameResVoStandardScheme();
    }
  }

  private static class OutletNameAndMerchantNameResVoStandardScheme extends StandardScheme<OutletNameAndMerchantNameResVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OutletNameAndMerchantNameResVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OutletNameAndMerchantNameResVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OutletNameAndMerchantNameResVoTupleSchemeFactory implements SchemeFactory {
    public OutletNameAndMerchantNameResVoTupleScheme getScheme() {
      return new OutletNameAndMerchantNameResVoTupleScheme();
    }
  }

  private static class OutletNameAndMerchantNameResVoTupleScheme extends TupleScheme<OutletNameAndMerchantNameResVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OutletNameAndMerchantNameResVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OutletNameAndMerchantNameResVo struct) throws org.apache.thrift.TException {
