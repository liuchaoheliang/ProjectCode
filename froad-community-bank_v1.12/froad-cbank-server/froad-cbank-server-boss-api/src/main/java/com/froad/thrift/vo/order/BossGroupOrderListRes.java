...
public class BossGroupOrderListRes implements org.apache.thrift.TBase<BossGroupOrderListRes, BossGroupOrderListRes._Fields>, java.io.Serializable, Cloneable, Comparable<BossGroupOrderListRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BossGroupOrderListRes");
  ...
  static {
    schemes.put(StandardScheme.class, new BossGroupOrderListResStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BossGroupOrderListResTupleSchemeFactory());
  }

  /**
   * 订单数据
   */
  public List<BossGroupOrderVo> orders; // required
  /**
   * 查询结果
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.ORDERS, new org.apache.thrift.meta_data.FieldMetaData("orders", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "BossGroupOrderVo"))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BossGroupOrderListRes.class, metaDataMap);
  }

  public BossGroupOrderListRes() {
  }

  public BossGroupOrderListRes(
    List<BossGroupOrderVo> orders,
   ...
   */
  public BossGroupOrderListRes(BossGroupOrderListRes other) {
    if (other.isSetOrders()) {
      List<BossGroupOrderVo> __this__orders = new ArrayList<BossGroupOrderVo>(other.orders.size());
      for (BossGroupOrderVo other_element : other.orders) {
  ...
  public BossGroupOrderListRes deepCopy() {
    return new BossGroupOrderListRes(this);
  }
  ...
  public java.util.Iterator<BossGroupOrderVo> getOrdersIterator() {
    return (this.orders == null) ? null : this.orders.iterator();
  }

  public void addToOrders(BossGroupOrderVo elem) {
    if (this.orders == null) {
      this.orders = new ArrayList<BossGroupOrderVo>();
    }
   ...
   * 订单数据
   */
  public List<BossGroupOrderVo> getOrders() {
    return this.orders;
  }
   ...
   * 订单数据
   */
  public BossGroupOrderListRes setOrders(List<BossGroupOrderVo> orders) {
    this.orders = orders;
    return this;
  }
   ...
   * 查询结果
   */
  public BossGroupOrderListRes setResultVo(com.froad.thrift.vo.ResultVo resultVo) {
    this.resultVo = resultVo;
    return this;
  }
   ...
   * 分页数据
   */
  public BossGroupOrderListRes setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ORDERS:
      if (value == null) {
        ...
        setOrders((List<BossGroupOrderVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BossGroupOrderListRes)
      return this.equals((BossGroupOrderListRes)that);
    return false;
  }

  public boolean equals(BossGroupOrderListRes that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BossGroupOrderListRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BossGroupOrderListRes(");
    boolean first = true;
  ...
  private static class BossGroupOrderListResStandardSchemeFactory implements SchemeFactory {
    public BossGroupOrderListResStandardScheme getScheme() {
      return new BossGroupOrderListResStandardScheme();
    }
  }

  private static class BossGroupOrderListResStandardScheme extends StandardScheme<BossGroupOrderListRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BossGroupOrderListRes struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.orders = new ArrayList<BossGroupOrderVo>(_list0.size);
                BossGroupOrderVo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new BossGroupOrderVo();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossGroupOrderListRes struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.orders != null) {
        oprot.writeFieldBegin(ORDERS_FIELD_DESC);
        {
          ...
          for (BossGroupOrderVo _iter3 : struct.orders)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class BossGroupOrderListResTupleSchemeFactory implements SchemeFactory {
    public BossGroupOrderListResTupleScheme getScheme() {
      return new BossGroupOrderListResTupleScheme();
    }
  }

  private static class BossGroupOrderListResTupleScheme extends TupleScheme<BossGroupOrderListRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BossGroupOrderListRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOrders()) {
        {
          ...
          for (BossGroupOrderVo _iter4 : struct.orders)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BossGroupOrderListRes struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list5 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.orders = new ArrayList<BossGroupOrderVo>(_list5.size);
          BossGroupOrderVo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new BossGroupOrderVo();
            _elem6.read(iprot);
