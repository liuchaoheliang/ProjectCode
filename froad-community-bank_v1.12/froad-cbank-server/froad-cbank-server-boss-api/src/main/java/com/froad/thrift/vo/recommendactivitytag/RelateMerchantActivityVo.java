...
public class RelateMerchantActivityVo implements org.apache.thrift.TBase<RelateMerchantActivityVo, RelateMerchantActivityVo._Fields>, java.io.Serializable, Cloneable, Comparable<RelateMerchantActivityVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RelateMerchantActivityVo");
  ...
  static {
    schemes.put(StandardScheme.class, new RelateMerchantActivityVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RelateMerchantActivityVoTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.LICENSE,_Fields.WEIGHT,_Fields.ACTIVITY_ID,_Fields.ACTIVITY_NO,_Fields.CLIENT_ID,_Fields.OPERATOR};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RelateMerchantActivityVo.class, metaDataMap);
  }

  public RelateMerchantActivityVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public RelateMerchantActivityVo(RelateMerchantActivityVo other) {
  ...
  public RelateMerchantActivityVo deepCopy() {
    return new RelateMerchantActivityVo(this);
  }
   ...
   * 营业执照 *
   */
  public RelateMerchantActivityVo setLicense(String license) {
   ...
   * 权重 *
   */
  public RelateMerchantActivityVo setWeight(String weight) {
    this.weight = weight;
    return this;
  }
   ...
   * 活动标签id *
   */
  public RelateMerchantActivityVo setActivityId(long activityId) {
   ...
   * 活动编号 *
   */
  public RelateMerchantActivityVo setActivityNo(String activityNo) {
   ...
   * 客户端号 *
   */
  public RelateMerchantActivityVo setClientId(String clientId) {
   ...
   * 当前操作员 *
   */
  public RelateMerchantActivityVo setOperator(String operator) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RelateMerchantActivityVo)
      return this.equals((RelateMerchantActivityVo)that);
    return false;
  }

  public boolean equals(RelateMerchantActivityVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RelateMerchantActivityVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RelateMerchantActivityVo(");
    boolean first = true;
  ...
  private static class RelateMerchantActivityVoStandardSchemeFactory implements SchemeFactory {
    public RelateMerchantActivityVoStandardScheme getScheme() {
      return new RelateMerchantActivityVoStandardScheme();
    }
  }

  private static class RelateMerchantActivityVoStandardScheme extends StandardScheme<RelateMerchantActivityVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RelateMerchantActivityVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RelateMerchantActivityVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RelateMerchantActivityVoTupleSchemeFactory implements SchemeFactory {
    public RelateMerchantActivityVoTupleScheme getScheme() {
      return new RelateMerchantActivityVoTupleScheme();
    }
  }

  private static class RelateMerchantActivityVoTupleScheme extends TupleScheme<RelateMerchantActivityVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RelateMerchantActivityVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RelateMerchantActivityVo struct) throws org.apache.thrift.TException {
