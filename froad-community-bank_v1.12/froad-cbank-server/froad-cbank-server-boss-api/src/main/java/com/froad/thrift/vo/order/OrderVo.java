...
public class OrderVo implements org.apache.thrift.TBase<OrderVo, OrderVo._Fields>, java.io.Serializable, Cloneable, Comparable<OrderVo> {
   ...
   * 客户名称
   */
  public OrderVo setMemberName(String memberName) {
    this.memberName = memberName;
    return this;
  }
   ...
   * 商户ID
   */
  public OrderVo setMerchantId(String merchantId) {
    this.merchantId = merchantId;
    return this;
  }
   ...
   * 商户名称
   */
  public OrderVo setMerchantName(String merchantName) {
    this.merchantName = merchantName;
    return this;
  }
   ...
   * 门店ID
   */
  public OrderVo setOutletId(String outletId) {
    this.outletId = outletId;
    return this;
  }
   ...
   * 方付通积分
   */
  public OrderVo setFftPoints(double fftPoints) {
    this.fftPoints = fftPoints;
    setFftPointsIsSet(true);
    return this;
  }
   ...
   * 银行积分
   */
  public OrderVo setBankPoints(double bankPoints) {
    this.bankPoints = bankPoints;
    setBankPointsIsSet(true);
    return this;
  }
