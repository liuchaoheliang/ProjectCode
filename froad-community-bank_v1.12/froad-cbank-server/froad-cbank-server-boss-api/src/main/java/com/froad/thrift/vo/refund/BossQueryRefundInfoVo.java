...
public class BossQueryRefundInfoVo implements org.apache.thrift.TBase<BossQueryRefundInfoVo, BossQueryRefundInfoVo._Fields>, java.io.Serializable, Cloneable, Comparable<BossQueryRefundInfoVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BossQueryRefundInfoVo");
  ...
  private static final org.apache.thrift.protocol.TField REFUND_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("refundTime", org.apache.thrift.protocol.TType.I64, (short)11);
  ...
  static {
    schemes.put(StandardScheme.class, new BossQueryRefundInfoVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BossQueryRefundInfoVoTupleSchemeFactory());
  }
   ...
   * 退款商品列表
   */
  public List<BossQueryRefundProductVo> productList; // required
  /**
   * 退款商品列表
   */
  public List<BossQueryRefundPaymentVo> payList; // required
  /**
   * 银行端ID
   */
  ...
  private static final int __REFUNDAMOUNT_ISSET_ID = 1;
  private static final int __REFUNDPOINTS_ISSET_ID = 2;
  ...
  static {
    ...
    tmpMap.put(_Fields.PRODUCT_LIST, new org.apache.thrift.meta_data.FieldMetaData("productList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "BossQueryRefundProductVo"))));
    tmpMap.put(_Fields.PAY_LIST, new org.apache.thrift.meta_data.FieldMetaData("payList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "BossQueryRefundPaymentVo"))));
    tmpMap.put(_Fields.CLIENT_ID, new org.apache.thrift.meta_data.FieldMetaData("clientId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BossQueryRefundInfoVo.class, metaDataMap);
  }

  public BossQueryRefundInfoVo() {
  }
  ...
  public BossQueryRefundInfoVo(
    ...
    String merchantName,
    long refundTime,
    List<BossQueryRefundProductVo> productList,
    List<BossQueryRefundPaymentVo> payList,
    String clientId)
  {
    this();
   ...
   */
  public BossQueryRefundInfoVo(BossQueryRefundInfoVo other) {
    ...
    if (other.isSetProductList()) {
      List<BossQueryRefundProductVo> __this__productList = new ArrayList<BossQueryRefundProductVo>(other.productList.size());
      for (BossQueryRefundProductVo other_element : other.productList) {
        __this__productList.add(other_element);
      }
      this.productList = __this__productList;
    }
    if (other.isSetPayList()) {
      List<BossQueryRefundPaymentVo> __this__payList = new ArrayList<BossQueryRefundPaymentVo>(other.payList.size());
      for (BossQueryRefundPaymentVo other_element : other.payList) {
        __this__payList.add(other_element);
      }
  ...
  public BossQueryRefundInfoVo deepCopy() {
    return new BossQueryRefundInfoVo(this);
  }
   ...
   * 退款ID
   */
  public BossQueryRefundInfoVo setRefundId(String refundId) {
    this.refundId = refundId;
    return this;
  }
   ...
   * 原订单号
   */
  public BossQueryRefundInfoVo setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 退款申请时间
   */
  public BossQueryRefundInfoVo setRequestTime(long requestTime) {
    this.requestTime = requestTime;
    setRequestTimeIsSet(true);
    return this;
  }
   ...
   * 退款状态
   */
  public BossQueryRefundInfoVo setRefundStatus(String refundStatus) {
    this.refundStatus = refundStatus;
    return this;
  }
   ...
   * 退款金额
   */
  public BossQueryRefundInfoVo setRefundAmount(double refundAmount) {
    this.refundAmount = refundAmount;
    setRefundAmountIsSet(true);
    return this;
  }
   ...
   * 退还积分
   */
  public BossQueryRefundInfoVo setRefundPoints(double refundPoints) {
    this.refundPoints = refundPoints;
    setRefundPointsIsSet(true);
    return this;
  }
   ...
   * 退款原因
   */
  public BossQueryRefundInfoVo setReason(String reason) {
    this.reason = reason;
    return this;
  }
   ...
   * 原子订单号
   */
  public BossQueryRefundInfoVo setSubOrderId(String subOrderId) {
    this.subOrderId = subOrderId;
    return this;
  }
   ...
   * 商户ID
   */
  public BossQueryRefundInfoVo setMerchantId(String merchantId) {
    this.merchantId = merchantId;
    return this;
  }
   ...
   * 商户名
   */
  public BossQueryRefundInfoVo setMerchantName(String merchantName) {
    this.merchantName = merchantName;
    return this;
  }
   ...
   * 退款时间
   */
  public BossQueryRefundInfoVo setRefundTime(long refundTime) {
    this.refundTime = refundTime;
    setRefundTimeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<BossQueryRefundProductVo> getProductListIterator() {
    return (this.productList == null) ? null : this.productList.iterator();
  }

  public void addToProductList(BossQueryRefundProductVo elem) {
    if (this.productList == null) {
      this.productList = new ArrayList<BossQueryRefundProductVo>();
    }
   ...
   * 退款商品列表
   */
  public List<BossQueryRefundProductVo> getProductList() {
   ...
   * 退款商品列表
   */
  public BossQueryRefundInfoVo setProductList(List<BossQueryRefundProductVo> productList) {
    this.productList = productList;
    return this;
  }
  ...
  public java.util.Iterator<BossQueryRefundPaymentVo> getPayListIterator() {
    return (this.payList == null) ? null : this.payList.iterator();
  }

  public void addToPayList(BossQueryRefundPaymentVo elem) {
    if (this.payList == null) {
      this.payList = new ArrayList<BossQueryRefundPaymentVo>();
    }
   ...
   * 退款商品列表
   */
  public List<BossQueryRefundPaymentVo> getPayList() {
    return this.payList;
  }
   ...
   * 退款商品列表
   */
  public BossQueryRefundInfoVo setPayList(List<BossQueryRefundPaymentVo> payList) {
    this.payList = payList;
    return this;
  }
   ...
   * 银行端ID
   */
  public BossQueryRefundInfoVo setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PRODUCT_LIST:
      if (value == null) {
        ...
        setProductList((List<BossQueryRefundProductVo>)value);
      }
      break;
    ...
    case PAY_LIST:
      if (value == null) {
        ...
        setPayList((List<BossQueryRefundPaymentVo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BossQueryRefundInfoVo)
      return this.equals((BossQueryRefundInfoVo)that);
    return false;
  }

  public boolean equals(BossQueryRefundInfoVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BossQueryRefundInfoVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BossQueryRefundInfoVo(");
    boolean first = true;
  ...
  private static class BossQueryRefundInfoVoStandardSchemeFactory implements SchemeFactory {
    public BossQueryRefundInfoVoStandardScheme getScheme() {
      return new BossQueryRefundInfoVoStandardScheme();
    }
  }

  private static class BossQueryRefundInfoVoStandardScheme extends StandardScheme<BossQueryRefundInfoVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BossQueryRefundInfoVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productList = new ArrayList<BossQueryRefundProductVo>(_list8.size);
                BossQueryRefundProductVo _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new BossQueryRefundProductVo();
                  _elem9.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.payList = new ArrayList<BossQueryRefundPaymentVo>(_list11.size);
                BossQueryRefundPaymentVo _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = new BossQueryRefundPaymentVo();
                  _elem12.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossQueryRefundInfoVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.productList != null) {
        oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
        {
          ...
          for (BossQueryRefundProductVo _iter14 : struct.productList)
          {
            _iter14.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.payList != null) {
        oprot.writeFieldBegin(PAY_LIST_FIELD_DESC);
        {
          ...
          for (BossQueryRefundPaymentVo _iter15 : struct.payList)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class BossQueryRefundInfoVoTupleSchemeFactory implements SchemeFactory {
    public BossQueryRefundInfoVoTupleScheme getScheme() {
      return new BossQueryRefundInfoVoTupleScheme();
    }
  }

  private static class BossQueryRefundInfoVoTupleScheme extends TupleScheme<BossQueryRefundInfoVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BossQueryRefundInfoVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProductList()) {
        {
          ...
          for (BossQueryRefundProductVo _iter16 : struct.productList)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetPayList()) {
        {
          ...
          for (BossQueryRefundPaymentVo _iter17 : struct.payList)
          {
            _iter17.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BossQueryRefundInfoVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.productList = new ArrayList<BossQueryRefundProductVo>(_list18.size);
          BossQueryRefundProductVo _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new BossQueryRefundProductVo();
            _elem19.read(iprot);
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.payList = new ArrayList<BossQueryRefundPaymentVo>(_list21.size);
          BossQueryRefundPaymentVo _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new BossQueryRefundPaymentVo();
            _elem22.read(iprot);
