...
public class MerchantWeightActivityTagVo implements org.apache.thrift.TBase<MerchantWeightActivityTagVo, MerchantWeightActivityTagVo._Fields>, java.io.Serializable, Cloneable, Comparable<MerchantWeightActivityTagVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MerchantWeightActivityTagVo");
  ...
  private static final org.apache.thrift.protocol.TField LICENSE_FIELD_DESC = new org.apache.thrift.protocol.TField("license", org.apache.thrift.protocol.TType.STRING, (short)11);
  ...
  private static final org.apache.thrift.protocol.TField AREA_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("areaName", org.apache.thrift.protocol.TType.STRING, (short)13);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new MerchantWeightActivityTagVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MerchantWeightActivityTagVoTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CLIENT_ID,_Fields.ACTIVITY_ID,_Fields.ACTIVITY_NO,_Fields.ELEMENT_ID,_Fields.WEIGHT,_Fields.ACTIVITY_TYPE,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.MERCHANT_NAME,_Fields.LICENSE,_Fields.OPERATOR,_Fields.AREA_NAME};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MerchantWeightActivityTagVo.class, metaDataMap);
  }

  public MerchantWeightActivityTagVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public MerchantWeightActivityTagVo(MerchantWeightActivityTagVo other) {
  ...
  public MerchantWeightActivityTagVo deepCopy() {
    return new MerchantWeightActivityTagVo(this);
  }
   ...
   * id *
   */
  public MerchantWeightActivityTagVo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
   ...
   * 客户端ID *
   */
  public MerchantWeightActivityTagVo setClientId(String clientId) {
   ...
   * 活动标签id *
   */
  public MerchantWeightActivityTagVo setActivityId(long activityId) {
   ...
   * 活动编号 *
   */
  public MerchantWeightActivityTagVo setActivityNo(String activityNo) {
   ...
   * 商户ID/门店ID/商品ID *
   */
  public MerchantWeightActivityTagVo setElementId(String elementId) {
   ...
   * 权重 *
   */
  public MerchantWeightActivityTagVo setWeight(String weight) {
    this.weight = weight;
    return this;
  }
   ...
   * 活动类型: 商户活动1; 门店活动2; 商品活动3 *
   */
  public MerchantWeightActivityTagVo setActivityType(String activityType) {
   ...
   * 创建时间 *
   */
  public MerchantWeightActivityTagVo setCreateTime(long createTime) {
   ...
   * 更新时间 *
   */
  public MerchantWeightActivityTagVo setUpdateTime(long updateTime) {
   ...
   * 商户名称 *
   */
  public MerchantWeightActivityTagVo setMerchantName(String merchantName) {
   ...
   * 营业执照 *
   */
  public MerchantWeightActivityTagVo setLicense(String license) {
   ...
   * 操作人 *
   */
  public MerchantWeightActivityTagVo setOperator(String operator) {
   ...
   * 所在地区 *
   */
  public MerchantWeightActivityTagVo setAreaName(String areaName) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MerchantWeightActivityTagVo)
      return this.equals((MerchantWeightActivityTagVo)that);
    return false;
  }

  public boolean equals(MerchantWeightActivityTagVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MerchantWeightActivityTagVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MerchantWeightActivityTagVo(");
    boolean first = true;
  ...
  private static class MerchantWeightActivityTagVoStandardSchemeFactory implements SchemeFactory {
    public MerchantWeightActivityTagVoStandardScheme getScheme() {
      return new MerchantWeightActivityTagVoStandardScheme();
    }
  }

  private static class MerchantWeightActivityTagVoStandardScheme extends StandardScheme<MerchantWeightActivityTagVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MerchantWeightActivityTagVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MerchantWeightActivityTagVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MerchantWeightActivityTagVoTupleSchemeFactory implements SchemeFactory {
    public MerchantWeightActivityTagVoTupleScheme getScheme() {
      return new MerchantWeightActivityTagVoTupleScheme();
    }
  }

  private static class MerchantWeightActivityTagVoTupleScheme extends TupleScheme<MerchantWeightActivityTagVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MerchantWeightActivityTagVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MerchantWeightActivityTagVo struct) throws org.apache.thrift.TException {
