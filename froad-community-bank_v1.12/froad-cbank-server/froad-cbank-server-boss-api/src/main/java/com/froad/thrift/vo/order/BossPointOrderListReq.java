...
public class BossPointOrderListReq implements org.apache.thrift.TBase<BossPointOrderListReq, BossPointOrderListReq._Fields>, java.io.Serializable, Cloneable, Comparable<BossPointOrderListReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BossPointOrderListReq");
  ...
  static {
    schemes.put(StandardScheme.class, new BossPointOrderListReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BossPointOrderListReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BossPointOrderListReq.class, metaDataMap);
  }

  public BossPointOrderListReq() {
  }
   ...
   */
  public BossPointOrderListReq(BossPointOrderListReq other) {
  ...
  public BossPointOrderListReq deepCopy() {
    return new BossPointOrderListReq(this);
  }
   ...
   * 所属客户端
   */
  public BossPointOrderListReq setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
   ...
   * 开始时间
   */
  public BossPointOrderListReq setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
   ...
   * 结束时间
   */
  public BossPointOrderListReq setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
   ...
   * 商品名称
   */
  public BossPointOrderListReq setProductName(String productName) {
    this.productName = productName;
    return this;
  }
   ...
   * 订单编号
   */
  public BossPointOrderListReq setSubOrderId(String subOrderId) {
    this.subOrderId = subOrderId;
    return this;
  }
   ...
   * 订单状态
   */
  public BossPointOrderListReq setOrderStatus(String orderStatus) {
    this.orderStatus = orderStatus;
    return this;
  }
   ...
   * 分页
   */
  public BossPointOrderListReq setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BossPointOrderListReq)
      return this.equals((BossPointOrderListReq)that);
    return false;
  }

  public boolean equals(BossPointOrderListReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BossPointOrderListReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BossPointOrderListReq(");
    boolean first = true;
  ...
  private static class BossPointOrderListReqStandardSchemeFactory implements SchemeFactory {
    public BossPointOrderListReqStandardScheme getScheme() {
      return new BossPointOrderListReqStandardScheme();
    }
  }

  private static class BossPointOrderListReqStandardScheme extends StandardScheme<BossPointOrderListReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BossPointOrderListReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossPointOrderListReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BossPointOrderListReqTupleSchemeFactory implements SchemeFactory {
    public BossPointOrderListReqTupleScheme getScheme() {
      return new BossPointOrderListReqTupleScheme();
    }
  }

  private static class BossPointOrderListReqTupleScheme extends TupleScheme<BossPointOrderListReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BossPointOrderListReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BossPointOrderListReq struct) throws org.apache.thrift.TException {
