...
public class BossMerchantCategoryVo implements org.apache.thrift.TBase<BossMerchantCategoryVo, BossMerchantCategoryVo._Fields>, java.io.Serializable, Cloneable, Comparable<BossMerchantCategoryVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BossMerchantCategoryVo");
  ...
  static {
    schemes.put(StandardScheme.class, new BossMerchantCategoryVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BossMerchantCategoryVoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BossMerchantCategoryVo.class, metaDataMap);
  }

  public BossMerchantCategoryVo() {
  }
   ...
   */
  public BossMerchantCategoryVo(BossMerchantCategoryVo other) {
  ...
  public BossMerchantCategoryVo deepCopy() {
    return new BossMerchantCategoryVo(this);
  }
   ...
   * 分类id
   */
  public BossMerchantCategoryVo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
   ...
   * 客户端id
   */
  public BossMerchantCategoryVo setClientId(String clientId) {
    this.clientId = clientId;
    return this;
  }
   ...
   * 分类名称
   */
  public BossMerchantCategoryVo setName(String name) {
    this.name = name;
    return this;
  }
   ...
   * 树路径 空格间隔
   */
  public BossMerchantCategoryVo setTreePath(String treePath) {
    this.treePath = treePath;
    return this;
  }
   ...
   * 父节点id
   */
  public BossMerchantCategoryVo setParentId(long parentId) {
    this.parentId = parentId;
    setParentIdIsSet(true);
    return this;
  }
   ...
   * 小图标
   */
  public BossMerchantCategoryVo setIcoUrl(String icoUrl) {
    this.icoUrl = icoUrl;
    return this;
  }
   ...
   * 排序
   */
  public BossMerchantCategoryVo setOrderValue(short orderValue) {
    this.orderValue = orderValue;
    setOrderValueIsSet(true);
    return this;
  }
   ...
   * 是否禁用
   */
  public BossMerchantCategoryVo setIsEnable(boolean isEnable) {
    this.isEnable = isEnable;
    setIsEnableIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BossMerchantCategoryVo)
      return this.equals((BossMerchantCategoryVo)that);
    return false;
  }

  public boolean equals(BossMerchantCategoryVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BossMerchantCategoryVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BossMerchantCategoryVo(");
    boolean first = true;
  ...
  private static class BossMerchantCategoryVoStandardSchemeFactory implements SchemeFactory {
    public BossMerchantCategoryVoStandardScheme getScheme() {
      return new BossMerchantCategoryVoStandardScheme();
    }
  }

  private static class BossMerchantCategoryVoStandardScheme extends StandardScheme<BossMerchantCategoryVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BossMerchantCategoryVo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossMerchantCategoryVo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BossMerchantCategoryVoTupleSchemeFactory implements SchemeFactory {
    public BossMerchantCategoryVoTupleScheme getScheme() {
      return new BossMerchantCategoryVoTupleScheme();
    }
  }

  private static class BossMerchantCategoryVoTupleScheme extends TupleScheme<BossMerchantCategoryVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BossMerchantCategoryVo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BossMerchantCategoryVo struct) throws org.apache.thrift.TException {
