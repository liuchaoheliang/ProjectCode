...
public class BossPresellOrderListReq implements org.apache.thrift.TBase<BossPresellOrderListReq, BossPresellOrderListReq._Fields>, java.io.Serializable, Cloneable, Comparable<BossPresellOrderListReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BossPresellOrderListReq");
  ...
  static {
    schemes.put(StandardScheme.class, new BossPresellOrderListReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BossPresellOrderListReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BossPresellOrderListReq.class, metaDataMap);
  }

  public BossPresellOrderListReq() {
  }
   ...
   */
  public BossPresellOrderListReq(BossPresellOrderListReq other) {
  ...
  public BossPresellOrderListReq deepCopy() {
    return new BossPresellOrderListReq(this);
  }
   ...
   * 订单编号
   */
  public BossPresellOrderListReq setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
   ...
   * 券号
   */
  public BossPresellOrderListReq setTicketId(String ticketId) {
    this.ticketId = ticketId;
    return this;
  }
   ...
   * 手机号
   */
  public BossPresellOrderListReq setPhone(String phone) {
    this.phone = phone;
    return this;
  }
   ...
   * "6"   - 退款失败：[6:退款失败;]
   */
  public BossPresellOrderListReq setTicketStatus(String ticketStatus) {
    this.ticketStatus = ticketStatus;
    return this;
  }
   ...
   * 结算状态0:未结算;1:结算中;2:结算成功;3:结算失败;4:无效结算记录
   */
  public BossPresellOrderListReq setSettlementStatus(String settlementStatus) {
    this.settlementStatus = settlementStatus;
    return this;
  }
   ...
   * 商品名称
   */
  public BossPresellOrderListReq setProductName(String productName) {
    this.productName = productName;
    return this;
  }
   ...
   * 用户名:提(收)货人姓名
   */
  public BossPresellOrderListReq setMemberName(String memberName) {
    this.memberName = memberName;
    return this;
  }
   ...
   * 支付开始时间
   */
  public BossPresellOrderListReq setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
   ...
   * 支付结束时间
   */
  public BossPresellOrderListReq setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
   ...
   * 分页
   */
  public BossPresellOrderListReq setPageVo(com.froad.thrift.vo.PageVo pageVo) {
    this.pageVo = pageVo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BossPresellOrderListReq)
      return this.equals((BossPresellOrderListReq)that);
    return false;
  }

  public boolean equals(BossPresellOrderListReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BossPresellOrderListReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BossPresellOrderListReq(");
    boolean first = true;
  ...
  private static class BossPresellOrderListReqStandardSchemeFactory implements SchemeFactory {
    public BossPresellOrderListReqStandardScheme getScheme() {
      return new BossPresellOrderListReqStandardScheme();
    }
  }

  private static class BossPresellOrderListReqStandardScheme extends StandardScheme<BossPresellOrderListReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BossPresellOrderListReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BossPresellOrderListReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BossPresellOrderListReqTupleSchemeFactory implements SchemeFactory {
    public BossPresellOrderListReqTupleScheme getScheme() {
      return new BossPresellOrderListReqTupleScheme();
    }
  }

  private static class BossPresellOrderListReqTupleScheme extends TupleScheme<BossPresellOrderListReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BossPresellOrderListReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BossPresellOrderListReq struct) throws org.apache.thrift.TException {
