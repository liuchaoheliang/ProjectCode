...
public class Client  implements java.io.Serializable {
    ...
    // Fields    
     ...
     private String settlePayOrg; 	//结算组织机构代码
     private String bankOrg;		//vip所属银行标签
     private String bankZH;			//银行组号
    ...
    /** full constructor */
    public Client(Date createTime, String clientId,String uri,String name, String pointPartnerNo, String openapiPartnerNo, String orderDisplay, String appkey, String appsecret, String bankType, String bankName, String qrLogo, String returnUrl, String remark,String bankId,String settlePayOrg,String bankOrg) {
        this.createTime = createTime;
        this.clientId = clientId;
        this.uri=uri;
        this.name = name;
