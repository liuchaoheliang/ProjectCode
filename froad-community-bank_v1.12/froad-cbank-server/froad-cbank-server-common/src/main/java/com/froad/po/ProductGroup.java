...
public class ProductGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public ProductGroup(Date createTime, String clientId, Date expireStartTime, Date expireEndTime) {
	...
	/** full constructor */
	public ProductGroup(Date createTime, String clientId, String productId, Integer trueBuyerNumber, Integer virtualBuyerNumber, Date expireStartTime, Date expireEndTime) {
		this.createTime = createTime;
		this.clientId = clientId;
