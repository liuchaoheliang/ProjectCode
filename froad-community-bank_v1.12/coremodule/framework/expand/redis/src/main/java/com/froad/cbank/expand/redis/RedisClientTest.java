...
import com.froad.cbank.expand.redis.RedisClient.PoolType;
...
@ContextConfiguration(locations = {"classpath:/conf/soft/spring/spring-expand-redis.xml"})
...
//    public void test(){
//    	//写池
//    	Jedis wjedis=RedisClient.getJedis(PoolType.write);
//    	System.out.println("=========连接数量："+RedisClient.jedisPoolActiveNum(PoolType.write));    	
//    	//读池
//    	Jedis rjedis=RedisClient.getJedis(PoolType.read);
//    	RedisClient.returnResource(rjedis,PoolType.read);
//    	System.out.println("=========连接数量："+RedisClient.jedisPoolActiveNum(PoolType.read));
//    	
//    	 System.out.println("======================String_1=========================="); 
//         // 清空数据 
//         System.out.println("清空库中所有数据："+wjedis.flushDB());
//         
//         System.out.println("=============增=============");
//         wjedis.set("key001","value001");
//         wjedis.set("key002","value002");
//         wjedis.set("key003","value003");
//         System.out.println("已新增的3个键值对如下：");
//         System.out.println(rjedis.get("key001"));
//         System.out.println(rjedis.get("key002"));
//         System.out.println(rjedis.get("key003"));
//    }
    
    @Test
    public void Test1(){
    	RedisManager r=new RedisManager();
    	System.out.println(r.putString("name", "liuchao"));
