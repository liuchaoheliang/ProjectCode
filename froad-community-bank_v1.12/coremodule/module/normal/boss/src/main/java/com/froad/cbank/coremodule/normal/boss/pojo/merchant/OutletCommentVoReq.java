...
public class OutletCommentVoReq extends Page implements Serializable {

	/**
	 * UID
	 */
	private static final long serialVersionUID = -5508064491749899888L;
	...
	private String recommentStatus;// 查询是否回复接受前端参数

	private OutletCommentVo outletCommentVo;
	...
	public OutletCommentVo getOutletCommentVo() {
		return outletCommentVo;
	}

	public void setOutletCommentVo(OutletCommentVo outletCommentVo) {
	...
	public String getRecommentStatus() {
		return recommentStatus;
	}

	public void setRecommentStatus(String recommentStatus) {
		this.recommentStatus = recommentStatus;
	}
