package com.froad.cbank.coremodule.normal.boss.common.db.mysql.interceptor;
...
import com.froad.cbank.coremodule.normal.boss.common.db.mysql.dialet.Dialect;
import com.froad.cbank.coremodule.normal.boss.common.db.mysql.util.ReflectUtil;
...
//		}
	...
	private String getCountSql(String sql) {
		...
		if(sql.toLowerCase().contains("group")){
			return "select count(0) from (" + sql + ") xxx";
		}
