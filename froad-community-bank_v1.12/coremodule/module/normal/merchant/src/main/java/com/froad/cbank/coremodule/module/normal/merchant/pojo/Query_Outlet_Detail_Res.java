...
public class Query_Outlet_Detail_Res{
	/**
	 * 主键ID
	 */
	private Long id; 
     ...
     * 门店分类列表信息
     */
    private List<Query_Outlet_Category_Res> categoryList;
	...
	public List<Query_Outlet_Category_Res> getCategoryList() {
		return categoryList;
	}

	public void setCategoryList(List<Query_Outlet_Category_Res> categoryList) {
