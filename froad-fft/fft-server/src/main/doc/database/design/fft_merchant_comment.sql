 ...
 * 商户点评表设计
 */
DROP TABLE IF EXISTS froadfft.fft_merchant_comment;
CREATE TABLE froadfft.fft_merchant_comment(
	...
	comment_description text DEFAULT NULL COMMENT '评论说明',
	...
	PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8  COMMENT='商户点评表';