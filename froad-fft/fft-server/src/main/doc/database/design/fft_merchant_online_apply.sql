 ...
 *商户在线申请表设计
 */
DROP TABLE IF EXISTS froadfft.fft_merchant_online_apply;
CREATE TABLE froadfft.fft_merchant_online_apply (
	...
	relation_account bigint(20) NOT NULL COMMENT '联系处理人',
	relation_time datetime NOT NULL COMMENT '联系处理时间',
	relation_mark  varchar(255) DEFAULT NULL COMMENT '联系处理备注',
	client_id bigint(20) NOT NULL COMMENT '所属客户端',
	PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8  COMMENT='商户在线申请';
