 ...
 * 文章分类设计
 */
DROP TABLE IF EXISTS `fft_article_category`;
CREATE TABLE `fft_article_category` (
  ...
  `tree_path` varchar(255) DEFAULT NULL COMMENT '树路劲',
  `parent_id` bigint(20) DEFAULT NULL COMMENT '上级分类ID',
  `data_state` int(11) NOT NULL COMMENT '基础数据状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100000000 DEFAULT CHARSET=utf8 COMMENT='文章分类';