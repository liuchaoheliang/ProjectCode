...
public class ProductDto implements Serializable{
	...
	private Long productPresellId;//商品预售
	...
	private ProductPresellDto productPresell;//商品预售信息
	...
	public ProductPresellDto getProductPresell() {
		return productPresell;
	}

	public void setProductPresell(ProductPresellDto productPresell) {
