...
$(document).ready( function() {
	...
	$('a.exchangeAffirmBut').click(function() {
	    ...
	    if (payMethod == "09")
	    {
	        ...
	        document.getElementById("exchangeSpecialtyAffirmForm").target = winName;
	        window.open("", winName);
	    }	
		$('#exchangeSpecialtyAffirmForm').submit()
	});
...
<!--付款确认开始-->
<form id="exchangeSpecialtyAffirmForm" method="post" action="transExchange.action">
