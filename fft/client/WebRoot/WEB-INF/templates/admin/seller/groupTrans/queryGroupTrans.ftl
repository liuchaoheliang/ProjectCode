...
<form id="listForm" action="query_group_trans.action" method="post">
    <div class="fromDiv">
      ...
      <table width="99%" border="0" cellspacing="0" cellpadding="0" class="tableA">
       ...
       <#list pager.list as trans>
         <tr id="${trans.id?c}">        	
         	...
         	<td>
         		<a class="ajaxlinkDetail" href="group_tran_detail_Info.action?trans.id=${trans.id?c}&authIdElse=${trans.authTicketId!""}"  title="查看详情">详情</a>
         	</td>
      	</tr>
       </#list>    
      </table>
