...
<!--   <script src="${base}/template/admin/js/from_validate.js" type="text/javascript"></script>   -->
...
<div id="errorMsg"><h2>${errorMessage?if_exists} </h2></div>
  ...
  <div class="stepgive"></div>
    <div class="step">
      ...
      <li class="step03">赠送完成</li>
    </div>   
   <form id="formlist" action="create_order_of_send_points.action" method="post">
    <div class="inforBox validate" id="admin">
        <dl>
          ...
          <dd>
            <div> 
            <strong>
            <input id="phone" name="buyerPhone" type="text" class="loginText" maxlength="11"><u>*</u>
            </strong> 
            </div>
          </dd>
        </dl> 
        ...
        <dl>
          ...
          <dd>
            <div> 
            <strong>
            <input id="price" name="tranDetail.goods.price" type="text" class="loginText4"  onChange="countRealCurrencyValue()" />
             <u>*</u>
            </strong>
         ...
         <input id="pricecheckResult"  type="hidden" class="loginText" value="false">   
        <dl>
          <dt>消费名称：</dt>
          <dd>
            <div>
            <strong>
            <input id="name" name="tranDetail.goods.goodsName" type="text" maxlength="15" class="loginText grayFont" value="<#if merchant.mstoreShortName?exists>${(merchant.mstoreShortName?html)!''}</#if>">
            </strong>
            </div>
          </dd>
        </dl>
