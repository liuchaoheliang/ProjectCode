...
function queryPayResult(){
	createXMLHttpRequest(); 
     ...
     var url = "queryPresellPayResult.action?trans.id=${(trans.id?c)?if_exists}";
...
<div class="box1010 pt10 clear">
  ...
  <div class="result fl">
   ...
   <div class="messageBox" id="pay" style="display:none">
        <dl>
          <dt>等待付款……</dt>
          <dd class="grayFont f12">如果您已完成付款，请<a href="javascript:queryPayResult()" value="点击刷新">点击刷新</a>
        </dl>  
    </div>
    <!--等待付款-->
    ...
    <div class="successBox" id="paySuccess" style="display:none"> 
	 ...
	 <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>提示信息：您已成功参与预售，成团后提货券将会发送到您的手机号码上，请关注商品提货日期及提货地点等信息。</td>
          </tr>
        <tr>
