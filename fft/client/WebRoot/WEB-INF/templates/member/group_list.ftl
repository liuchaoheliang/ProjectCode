...
<div class="rightBox" id="rightHeight">
  ...
  <form id="listForm" action="group_trans_list.action" method="post">
    <div class="fromDiv">
       ...
       <#list pager.list as trans>
         ...
         <tr id="${trans.id?c}">
	        ...
	        <td id="duanxin">
	       		...
	       		<a class="ajaxlinkDetail" href="group_tran_detail_Info.action?trans.id=${trans.id?c}<#if trans.authTicketId?exists>&authIdElse=${trans.authTicketId}</#if>"  title="查看详情">详情</a>
