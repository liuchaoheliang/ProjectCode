...
<!--会员个人信息菜单结束-->
 ...
 <!-- <div class="text"><b>提示：</b>您的分分通账户拥有分分通积分，为了您的分分通积分安全，更改手机号码需要先验证登录密码</div> -->
    <div class="inforBox validate">
    <form  name="formregedit" action="${base}/changeMobilePhone.action" method="post" id="formlist">
    <input type="hidden" class="loginText" id="validatePass" value="${validatePass!""}">
    <input type="hidden" class="loginText" value="3" id="phoneMessageType">
      <dl>
        <dt>新手机号：</dt>
        <dd>
          <div>
            <strong class="linkphone"><input name="mobilephone" type="text" class="loginText" id="phone" maxlength="11"><u>*</u>
            </strong>
          </div>
        </dd>
      </dl>      
     <dl>
       ...
       <dd>
         <div>
           <strong class="linkphone"><input name="valPhoneCode" id="phonecode" type="text" maxlength="6" class="loginText3"/><u>*</u>
      ...
      <div class="ml130 mt5"> 
        <a href="javascript:void(0);">
          <div class="textBtn" id="sendValidate"><B>下一步</B></div>
        </a> 
      </div>
...
function changeMobilePhone(){		
	var $validatePass = $('#validatePass').val();
