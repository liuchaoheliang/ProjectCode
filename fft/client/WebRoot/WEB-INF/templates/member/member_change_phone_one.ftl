...
<!--会员个人信息菜单结束-->
  ...
  <div class="text"><b>提示：</b>为了您的分分通积分安全，更改手机号码需要先验证登录密码</div>
	...
	<form  name="formregedit" action="${base}/validateChangeMobilePhone.action" method="post" id="formlist">
      ...
      <div class="ml130 mt5"> 
        <a href="javascript:void(0);">
          <div class="textBtn" id="sendNext2"><B>下一步</B></div>
        </a> 
      </div>
...
$("#sendNext2").click(function(){
	...
	for (i = 0; i < ob.length; i++) {
		...
		if (oc.value == '') {
			...
			if (oc.id == "username" || oc.id == "password" || oc.id == "password2" || oc.id == "phone" || oc.id == "phone2" || oc.id == "password6") {
