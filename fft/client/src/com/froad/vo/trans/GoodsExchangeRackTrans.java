...
import com.froad.client.goodsExchangeRack.Merchant;
import com.froad.client.goodsExchangeRack.Seller;


public class GoodsExchangeRackTrans {
	...
	public String toString() {
		return "GoodsExchangeRack [bankPointCashPricingDesc="
				...
				+ ", marketTotalNumber=" + marketTotalNumber + ", merchant="
				+ merchant + ", merchantId=" + merchantId + ", rackTime="
