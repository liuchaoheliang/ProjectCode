 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://service.CB.froad.com/}merchantOnlineApply" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetByUserIdResponse {
    ...
    protected List<MerchantOnlineApply> _return;
     ...
     * 
     */
    public List<MerchantOnlineApply> getReturn() {
        if (_return == null) {
            _return = new ArrayList<MerchantOnlineApply>();
        }
        return this._return;
    }
