 ...
 *         &lt;element name="orderType" type="{http://service.CB.froad.com/}orderType" minOccurs="0"/>
...
@XmlSeeAlso({
    ...
    MerchantPreferential.class,
    GoodsPresellRack.class,
    Trans.class,
    GoodsExchangeRack.class,
    GoodsCarryRack.class,
    ClientGoodsGroupRack.class,
    ClientGoodsCarryRack.class,
    ClientGoodsExchangeRack.class,
    AuthTicket.class,
    GoodsGatherRack.class,
    Goods.class,
    Rule.class,
    ClientGoodsGatherRack.class,
    Merchant.class,
    MerchantPhoto.class,
    User.class,
    GoodsGroupRack.class
})
public class Pager {
