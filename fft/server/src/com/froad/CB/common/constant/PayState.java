...
public class PayState {
	...
	public static String LOTTERY_REQ_SUCCESS="4101";//发送彩票请求成功（出票中）
	public static String LOTTERY_REQ_FAIL="4102";//发送彩票请求失败（出票失败）
	public static String LOTTERY_SUCCESS="4103";//彩票购买成功（出票成功）
	public static String LOTTERY_FAIL="4104";//彩票购买失败（出票失败）
	public static String LOTTERY_WIN="4105";//彩票中奖（已中奖派奖中）
	public static String LOTTERY_SEND="4106";//已派奖（已派奖）
