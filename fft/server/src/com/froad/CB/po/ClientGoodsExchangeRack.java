 ...
 * 商品兑换架
 */
public class ClientGoodsExchangeRack extends Pager{
	...
	*/
	...
	private List<ClientGoodsExchangeRackImages> clientGoodsExchangeRackImagesList=new ArrayList<ClientGoodsExchangeRackImages>();
	
	public List<ClientGoodsExchangeRackImages> getClientGoodsExchangeRackImagesList() {
		return clientGoodsExchangeRackImagesList;
	}
	public void setClientGoodsExchangeRackImagesList(
			List<ClientGoodsExchangeRackImages> clientGoodsExchangeRackImagesList) {
		this.clientGoodsExchangeRackImagesList = clientGoodsExchangeRackImagesList;
	}
