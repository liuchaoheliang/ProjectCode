...
import java.io.Serializable;
	 ...
	 * @time: Dec 13, 2012 5:38:26 PM 
	 */
public class TagClassifyB implements Serializable {
	...
	private String parentTagClassifyId;
	...
	public void setParentTagClassifyId(String parentTagClassifyId) {
		this.parentTagClassifyId = parentTagClassifyId;
	}

	@Override
	public String toString() {
		return "TagClassifyB [createTime=" + createTime + ", description="
				+ description + ", id=" + id + ", parentTagClassifyId="
				+ parentTagClassifyId + ", remark=" + remark + ", siteValue="
