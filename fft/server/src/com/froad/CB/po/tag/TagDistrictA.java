...
import java.io.Serializable;
	 ...
	 * @time: Dec 13, 2012 5:38:36 PM 
	 */
public class TagDistrictA implements Serializable {
	...
	public String toString() {
		return "TagDistrictA [createTime=" + createTime + ", description="
				+ description + ", id=" + id + ", remark=" + remark
				+ ", siteValue=" + siteValue + ", sortValue=" + sortValue
				+ ", state=" + state + ", tagHyperlink=" + tagHyperlink
