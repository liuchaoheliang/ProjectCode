...
public class GoodsGroupRack extends Pager{
	...
	private List<GoodsGroupRackImages> goodsGroupRackImages;
	...
	public List<GoodsGroupRackImages> getGoodsGroupRackImages() {
		return goodsGroupRackImages;
	}
	
	public void setGoodsGroupRackImages(
			List<GoodsGroupRackImages> goodsGroupRackImages) {
		this.goodsGroupRackImages = goodsGroupRackImages;
	}
