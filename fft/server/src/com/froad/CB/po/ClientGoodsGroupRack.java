...
public class ClientGoodsGroupRack extends Pager{
	...
	private Integer refundTotalNumber;	//退款数量
	...
	private List<ClientGoodsGroupRackImages> clientGoodsGroupRackImagesList=new ArrayList<ClientGoodsGroupRackImages>();
	...
	public List<ClientGoodsGroupRackImages> getClientGoodsGroupRackImagesList() {
		return clientGoodsGroupRackImagesList;
	}

	public void setClientGoodsGroupRackImagesList(
			List<ClientGoodsGroupRackImages> clientGoodsGroupRackImagesList) {
		this.clientGoodsGroupRackImagesList = clientGoodsGroupRackImagesList;
	}
	...
	public void setRefundTotalNumber(Integer refundTotalNumber) {
