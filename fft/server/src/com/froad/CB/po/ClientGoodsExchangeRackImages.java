...
public class ClientGoodsExchangeRackImages {
	private Integer id;
	private String clientGoodsExchangeRackId;//兑换商品ID
	...
	public void setClientGoodsExchangeRackId(String clientGoodsExchangeRackId) {
		this.clientGoodsExchangeRackId = clientGoodsExchangeRackId;
	}
