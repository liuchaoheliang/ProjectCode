...
public class ClientGoodsRebateRack extends Pager{
	...
	private List<ClientGoodsRebateRackImages> clientGoodsRebateRackImagesList=new ArrayList<ClientGoodsRebateRackImages>();
	...
	public List<ClientGoodsRebateRackImages> getClientGoodsRebateRackImagesList() {
		return clientGoodsRebateRackImagesList;
	}

	public void setClientGoodsRebateRackImagesList(
			List<ClientGoodsRebateRackImages> clientGoodsRebateRackImagesList) {
		this.clientGoodsRebateRackImagesList = clientGoodsRebateRackImagesList;
	}
