//买家资金渠道
CREATE TABLE `buyers_deposit_channel` (
  `id` int(32) NOT NULL auto_increment COMMENT '主键 自增100001001开始',
  `user_id` varchar(36) NOT NULL COMMENT '关联会员 user',
  `buyers_id` varchar(32) NOT NULL COMMENT '买家ID 关联Buyers',
  `buyers_rule_id` varchar(32) NOT NULL COMMENT '买家规则ID 关联卖家规则BuyersRule',
  ...
  UNIQUE KEY `buyers_rule_id` (`buyers_rule_id`),
